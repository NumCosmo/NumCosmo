...
$$\delta f_i = f^\mathrm{obs}_i - f(x_i),$$
as a multivariate Gaussian distribution with zero mean and covariance $C_{ij}$ randomly generated
the standard deviation of $\delta_ f_i$ will be draw from a uniform distribution between $[0.5, 2]$.

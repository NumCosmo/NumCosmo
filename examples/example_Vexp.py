...
cosmo1.props.alphab   = +1.1007e-1
cosmo1.props.sigmaphi = +6.8e0
cosmo1.props.dphi     = -5.0e-2
#cosmo1.props.xb       = 4.8e37
cosmo1.props.xb       = 1.0e37
cosmo1.props.OmegaL   = 1.0
cosmo1.props.Omegac   = 1.0
cosmo1.props.H0       = 67.8

cosmo2.props.alphab   = +1.0e-20
cosmo2.props.sigmaphi = +8.0e-1
cosmo2.props.dphi     = -5.0e-1
#cosmo2.props.xb       = 4.8e37
cosmo2.props.xb       = 1.0e37
cosmo2.props.OmegaL   = 1.0
cosmo2.props.Omegac   = 1.0
cosmo2.props.H0       = 67.8

tau_min = max (cosmo1.tau_min (), cosmo1.tau_xc (1.0e12))
tau_max = min (cosmo1.tau_max (), -cosmo1.tau_xc (1.0e12))
k       = 1.0e0
xb      = cosmo1.xbe ()

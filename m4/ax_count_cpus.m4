...
#   warranty.
#   
#   Extended by Sandro Vitenti sandro@isoftware.com.br
#
      ...
      AS_CASE([$host_os],[
        ...
        *linux*],[
        AS_IF([test "x$CPU_COUNT" = "x0" -a -e /proc/cpuinfo],[
          AS_IF([test "x$CPU_COUNT" = "x0" -a -e /proc/cpuinfo],[
            CPU_COUNT="`cat /proc/cpuinfo | $EGREP "^cpu cores[[[:space:]]]+\:[[[:space:]]]*[[0-9]]+[[[:space:]]]*$" | $SED q | $SED 's/[[^0-9]]//g'`"
            AS_IF([echo "$CPU_COUNT" | $EGREP '[[^0-9]]' >/dev/null],[

...
code_coverage_v_lcov_ign_0 = @echo \"  LCOV   --remove \" \$(CODE_COVERAGE_IGNORE_PATTERN);
...
code-coverage-capture: code-coverage-capture-hook
 ...
 ifneq (\$(CODE_COVERAGE_IGNORE_PATTERN),)
	...
	-@mv \"\$(CODE_COVERAGE_OUTPUT_FILE).tmp\" \"\$(CODE_COVERAGE_OUTPUT_FILE)\"
 endif

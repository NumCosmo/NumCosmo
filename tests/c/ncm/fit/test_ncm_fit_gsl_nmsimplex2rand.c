...
/*
 * gsl:nmsimplex2rand. Every check lives in test_ncm_fit_common.c; this file names the
...
static const TestNcmFitAlgo algo = {
  .lib       = "gsl",
  .algo      = "nmsimplex2rand",
  .fit_type  = NCM_FIT_TYPE_GSL_MMS,
  .algo_str  = "nmsimplex2rand",
  .fit_gtype = ncm_fit_gsl_mms_get_type,
  .max_dim   = TEST_NCM_FIT_DIM_SMALL,
  .max_iter  = 10000000,
};

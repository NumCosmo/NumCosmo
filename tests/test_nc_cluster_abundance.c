...
test_nc_cluster_abundance_new (TestNcClusterAbundance *test, gconstpointer pdata)
{
  ...
  test->clusterm = NC_CLUSTER_MASS (nc_cluster_mass_new_from_name ("NcClusterMassAscaso"));
  test->clusterz = NC_CLUSTER_REDSHIFT (nc_cluster_redshift_new_from_name ("NcClusterRedshiftNodist{'z-min':<0.1>, 'z-max':<1.0>}")); 
...
const gdouble lnM_obs_bin_upper[1] = {1};
const gdouble z_obs_bin_lower[1] = {0.1};
const gdouble z_obs_bin_upper[1] = {0.3};

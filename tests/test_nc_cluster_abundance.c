...
void test_nc_cluster_abundance_failing_intp_bin_d2n (TestNcClusterAbundance *test, gconstpointer pdata);
...
main (gint argc, gchar *argv[])
{
  ...
  g_test_add ("/nc/cluster_abundance/nc_cluster_abundance_failing_intp_bin_d2n", TestNcClusterAbundance, NULL,
              &test_nc_cluster_abundance_new,
              &test_nc_cluster_abundance_failing_intp_bin_d2n,
              &test_nc_cluster_abundance_free);
...
test_nc_cluster_abundance_new (TestNcClusterAbundance *test, gconstpointer pdata)
{
  ...
  NcClusterRedshift *clusterz = NC_CLUSTER_REDSHIFT (ncm_serialize_global_from_string ("NcClusterPhotozGaussGlobal{'pz-min':<0.1>, 'pz-max':<1.0>, 'z-bias':<0.0>, 'sigma0':<1.0e-2>}"));
...
test_nc_cluster_abundance_true_n (TestNcClusterAbundance *test, gconstpointer pdata)
{
  test_nc_cluster_abundance_sanity (test, pdata);
  {
    ...
    g_assert_true (gsl_finite (n1));
    g_assert_true (gsl_finite (n2));
...
test_nc_cluster_abundance_intp_d2n (TestNcClusterAbundance *test, gconstpointer pdata)
{
  test_nc_cluster_abundance_sanity (test, pdata);
  {
    ...
    g_assert_true (gsl_finite (d2n_1));
    g_assert_true (gsl_finite (d2n_2));
...
test_nc_cluster_abundance_mean_bias (TestNcClusterAbundance *test, gconstpointer pdata)
{
  test_nc_cluster_abundance_sanity (test, pdata);
  {
    ...
    g_assert_true (gsl_finite (mean_bias1));
    g_assert_true (gsl_finite (mean_bias2));
...
void
test_nc_cluster_abundance_failing_intp_bin_d2n (TestNcClusterAbundance *test, gconstpointer pdata)
{

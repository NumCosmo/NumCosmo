...
def test_m2lnL_gal_parity(shape_kind, z_kind):
    ...
    assert_allclose(new_gal.dup_array(), _GAL_PARITY_FROZEN[(shape_kind, z_kind)], rtol=1.0e-5)
...
def test_m2lnL_parity_fixed_nodes(shape_kind, z_kind):
    ...
    assert_allclose(new_m2lnL, _FIXED_NODES_PARITY_FROZEN[(shape_kind, z_kind)], rtol=1.0e-6)
...
_RESAMPLE_FROZEN = {
    ("global", "spline"): {
        200: {
            "cols": {
                "ra": [-0.10938103049993514, 0.09081182871013882, -0.15151121113449334, 0.18835634412243962, -0.032229752186685806],
                "dec": [-0.002342543371666539, 0.16387784329891236, -0.15068294679505903, 0.13041990375585624, -0.006571839549873736],
                "epsilon_obs_1": [0.45648033539105765, 0.1663836009567453, -0.14695473345308083, -0.13732948567043893, -0.2500497729429979],
                "epsilon_obs_2": [-0.11120904619770347, 0.2783205429969342, 0.17399840334584926, 0.6573851710590882, 0.07351834336953396],
            },
            "m2lnL": 11.018394045298528,
        },
        201: {
            "cols": {
                "ra": [0.0991523265838623, -0.08193042138591411, -0.1613445422612131, -0.1104948495514691, 0.19883551495149732],
                "dec": [0.011815003330658916, -0.14095807328119264, -0.1591939722196891, 0.08045418165202675, 0.07062092834004918],
                "epsilon_obs_1": [0.2400706797017566, 0.12772301607339823, -0.45334167657545993, 0.442176612285069, 0.35228716992034903],
                "epsilon_obs_2": [0.012534815790335677, 0.6295368994121021, 0.2117515767653088, 0.09270305453109257, 0.2935061754831782],
            },
            "m2lnL": 13.696895880397472,
        },
        202: {
            "cols": {
                "ra": [-0.09437827505171298, -0.10091683054342865, -0.035511021222919215, 0.19020439470186828, -0.062485269457101825],
                "dec": [-0.16729319407118493, 0.196417405822625, -0.009351967416939246, -0.12252664668627275, -0.11067259364819969],
                "epsilon_obs_1": [0.3895059484949051, 0.05908098971770451, 0.2164032326223062, -0.5579878644228332, -0.05055960539221188],
                "epsilon_obs_2": [-0.029635225039541573, -0.37187112768756386, 0.13540266942023446, 0.32227311248560575, -0.1425934220136959],
            },
    ...
    ("local", "spline"): {
        200: {
            "cols": {
                "ra": [-0.10938103049993514, 0.09081182871013882, -0.15151121113449334, 0.18835634412243962, -0.032229752186685806],
                "dec": [-0.002342543371666539, 0.16387784329891236, -0.15068294679505903, 0.13041990375585624, -0.006571839549873736],
                "epsilon_obs_1": [0.4291072559243664, 0.18082875225268236, -0.09979544586912373, -0.13968376790912976, -0.15383344922364683],
                "epsilon_obs_2": [-0.1054227767664152, 0.33697758528964006, 0.11883368833322652, 0.6653166774948261, 0.05104050617141078],
            },
        ...
        201: {
            "cols": {
                "ra": [0.0991523265838623, -0.08193042138591411, -0.1613445422612131, -0.1104948495514691, 0.19883551495149732],
                "dec": [0.011815003330658916, -0.14095807328119264, -0.1591939722196891, 0.08045418165202675, 0.07062092834004918],
                "epsilon_obs_1": [0.2260505469622028, 0.14810011589625438, -0.32042062024330925, 0.4468670679673635, 0.17970738387510146],
                "epsilon_obs_2": [0.013170848912011113, 0.7653632893752472, 0.16541137227461508, 0.09356092298968915, 0.17903879818465998],
            },
        ...
        202: {
            "cols": {
                "ra": [-0.09437827505171298, -0.10091683054342865, -0.035511021222919215, 0.19020439470186828, -0.062485269457101825],
                "dec": [-0.16729319407118493, 0.196417405822625, -0.009351967416939246, -0.12252664668627275, -0.11067259364819969],
                "epsilon_obs_1": [0.36722867630732325, 0.06761230493541316, 0.164123600178707, -0.5650374389486277, -0.02011099707880146],
                "epsilon_obs_2": [-0.02648397024810383, -0.43717546582244327, 0.0815714056480282, 0.32591027176316734, -0.06426499382088673],
            },
    ...
    ("local", "composed"): {
        200: {
            "cols": {
                "ra": [-0.09695609295740726, -0.0696467756293714, -0.05022352645173668, 0.04346251515671612, 0.18913167547434567],
                "dec": [0.03776798395647362, 0.19441098322911052, 0.17739633871756494, 0.12772756282210726, -0.16053321201176812],
                "zp": [0.29510266643050737, 0.42202300798875003, 0.43394969000964734, 0.7478088064032384, 0.1843946257314928],
                "epsilon_obs_1": [-0.192399396880827, -0.05276509717334017, -0.07503601723955886, 0.06285365069629259, -0.10534080367151903],
                "epsilon_obs_2": [0.08845010170029108, -0.18958692209328404, 0.48462383285136706, 0.46095263514892826, -0.23307743902836947],
            },
            "m2lnL": -14.942575662331928,
        },
        201: {
            "cols": {
                "ra": [0.12387672355398538, 0.08033701749518513, 0.1345349228009582, -0.10026516951620579, 0.07227679193019866],
                "dec": [0.08354788023234028, 0.059893120837202295, 0.11473177750808512, 0.17497459146381938, -0.13259673179593884],
                "zp": [0.6548159847504184, 0.18953662452973885, 1.2915012975325568, 1.1885385129355623, 0.3187867346606224],
                "epsilon_obs_1": [-0.25133825435297685, -0.5665287545950531, -0.09043737246226338, -0.14585441472782618, -0.1582377022520448],
                "epsilon_obs_2": [-0.27507764870163026, 0.2719542005829586, -0.4970742154970388, -0.24370796143310608, 0.006387202401500203],
            },
            "m2lnL": -9.844361094347786,
        },
        202: {
            "cols": {
                "ra": [-0.05359764909371734, -0.16520272409543396, -0.12252680212259293, 0.16697374572977425, -0.07057789023965598],
                "dec": [0.19094442645985876, -0.08152155538366941, 0.17366129982221604, -0.02985580512227511, 0.10222493124029813],
                "zp": [0.7914676254190821, 1.5022120317884804, 1.399243632416395, 0.22081792386533694, 0.37007993719054366],
                "epsilon_obs_1": [-0.11917460520568143, 0.09121427264944222, -0.019209314609747438, -0.14231676277603644, -0.007509292045900447],
                "epsilon_obs_2": [-0.1848270641810301, -0.6816503091552719, -0.18408346009791204, -0.3326162082648963, 0.130892529767581],
            },
...
def test_resample_matches_legacy(shape_kind, z_kind):
    ...
    for seed in (200, 201, 202):
        ...
        for col in shape_cols:
            new_vals = [new_obs.get(col, i) for i in range(n)]
            assert_allclose(new_vals, frozen["cols"][col], rtol=shape_rtol, atol=1.0e-12)

...
CLUSTER_MASS_EXT_DEFAULT_MU_P0: float = 4.0
CLUSTER_MASS_EXT_DEFAULT_MU_P1: float = 1.0
CLUSTER_MASS_EXT_DEFAULT_MU_P2: float = 0.1
CLUSTER_MASS_EXT_DEFAULT_MU_P3: float = 0.01
CLUSTER_MASS_EXT_DEFAULT_PARAMS_ABSTOL: float = 0.0
CLUSTER_MASS_EXT_DEFAULT_SIGMA_P0: float = 0.3
CLUSTER_MASS_EXT_DEFAULT_SIGMA_P1: float = 0.3
CLUSTER_MASS_EXT_DEFAULT_SIGMA_P2: float = 0.1
...
GALAXY_SD_SHAPE_INTRINSIC_BETA_DEFAULT_MU: float = 0.18
GALAXY_SD_SHAPE_INTRINSIC_BETA_DEFAULT_NU: float = 5.0
GALAXY_SD_SHAPE_INTRINSIC_BETA_DEFAULT_PARAMS_ABSTOL: float = 0.0
GALAXY_SD_SHAPE_INTRINSIC_GAUSS_DEFAULT_PARAMS_ABSTOL: float = 0.0
GALAXY_SD_SHAPE_INTRINSIC_GAUSS_DEFAULT_SIGMA: float = 0.3
...
HALO_CM_DIEMER15_LOCAL_SPARAM_LEN: int = 1
HALO_CM_DUFFY08_DEFAULT_PARAMS_ABSTOL: float = 0.0
HALO_CM_DUFFY08_LOCAL_SPARAM_LEN: int = 1
HALO_CM_DUTTON14_DEFAULT_PARAMS_ABSTOL: float = 0.0
HALO_CM_DUTTON14_LOCAL_SPARAM_LEN: int = 1
...
HALO_CM_PRADA12_DEFAULT_PARAMS_ABSTOL: float = 0.0
HALO_CM_PRADA12_LOCAL_SPARAM_LEN: int = 1
...
class ClusterMassExt(ClusterMassRichness):
    r"""
    :Constructors:

    ::

        ClusterMassExt(**properties)

    Object NcClusterMassExt

    Properties from NcClusterMassExt:
      mup0 -> gdouble: mup0
        mu_p0
      mup1 -> gdouble: mup1
        mu_p1
...
class ClusterMassExtClass(GObject.GPointer):
    r"""
    :Constructors:
...
class ClusterMassRichness(ClusterMass):
    ...
    ::
        ...
        ClusterMassRichness(**properties)

    Object NcClusterMassRichness
    ...
    def mu_sigma(self, lnM: float, z: float) -> typing.Tuple[float, float]: ...
    def set_sample_full_dist(self, on: bool) -> None: ...
    def sigma(self, lnM: float, z: float) -> float: ...

class ClusterMassRichnessClass(GObject.GPointer):
    r"""
    :Constructors:

    ::

        ClusterMassRichnessClass()
    """

    parent_class: ClusterMassClass = ...
    mu: typing.Callable[[ClusterMassRichness, float, float], float] = ...
    sigma: typing.Callable[[ClusterMassRichness, float, float], float] = ...
...
class DataSNIACov(NumCosmoMath.DataGaussCov):
    ...
    Properties from NcDataSNIACov:
      ...
      resample-type -> NcDataSNIACovResample: resample-type
        Resampling strategy
    ...
    class Props:
        ...
        resample_type: DataSNIACovResample
    ...
    def get_resample_type(self) -> DataSNIACovResample: ...
    def has_complete_cov(self) -> bool: ...
    ...
    def set_resample_type(self, resample_type: DataSNIACovResample) -> bool: ...
...
class Distance(GObject.Object):
    ...
    @staticmethod
    def angular_diameter_from_Dc(Dc: float, Omega_k: float, z: float) -> float: ...
    ...
    def comoving_volume_radial_integral(self, cosmo: HICosmo, z: float) -> float: ...
    ...
    @staticmethod
    def luminosity_from_Dc(Dc: float, Omega_k: float, z: float) -> float: ...
    ...
    @staticmethod
    def radial_volume_integral_from_Dc(Dc: float, Omega_k: float) -> float: ...
    ...
    @staticmethod
    def transverse_from_Dc(Dc: float, Omega_k: float) -> float: ...
...
class GalaxySDObsRedshiftClass(GObject.GPointer):
    ...
    integ: typing.Callable[
        [GalaxySDObsRedshift, bool], GalaxySDObsRedshiftIntegrand
    ] = ...
    prepare: typing.Callable[[GalaxySDObsRedshift, GalaxySDObsRedshiftData], None] = ...
    get_integ_lim: typing.Callable[
        [GalaxySDObsRedshift, NumCosmoMath.MSet, GalaxySDObsRedshiftData],
        typing.Tuple[float, float],
    ] = ...
...
class GalaxySDPosition(NumCosmoMath.Model):
    ...
    def do_integ(self, use_lnp: bool) -> GalaxySDPositionIntegrand: ...
    ...
    @staticmethod
    def id() -> int: ...
    def integ(self, use_lnp: bool) -> GalaxySDPositionIntegrand: ...
...
class GalaxySDPositionClass(GObject.GPointer):
    ...
    integ: typing.Callable[[GalaxySDPosition, bool], GalaxySDPositionIntegrand] = ...
...
class GalaxySDShape(NumCosmoMath.Model):
    ...
    @staticmethod
    def id() -> int: ...
    def integ(self, use_lnp: bool) -> GalaxySDShapeIntegrand: ...
    def lndet_jac(
...
class GalaxySDShapeIntrinsic(NumCosmoMath.Model):
    r"""
    :Constructors:

    ::

        GalaxySDShapeIntrinsic(**properties)

    Object NcGalaxySDShapeIntrinsic
    ...
    @staticmethod
    def clear(gsi: GalaxySDShapeIntrinsic) -> None: ...
    def do_data_init(self, data: GalaxySDShapeIntrinsicData) -> None: ...
    def do_e_rms(self, data: GalaxySDShapeIntrinsicData) -> float: ...
    def do_eval_residual(self, data: GalaxySDShapeIntrinsicData, x: float) -> float: ...
    def do_gen(
        self, data: GalaxySDShapeIntrinsicData, rng: NumCosmoMath.RNG
    ) -> typing.Tuple[float, float]: ...
    def do_prepare(self, data: GalaxySDShapeIntrinsicData) -> None: ...
    def e_rms(self, data: GalaxySDShapeIntrinsicData) -> float: ...
    def eval_p(self, data: GalaxySDShapeIntrinsicData, x: float) -> float: ...
    def eval_residual(self, data: GalaxySDShapeIntrinsicData, x: float) -> float: ...
    def free(self) -> None: ...
    def gen(
        self, data: GalaxySDShapeIntrinsicData, rng: NumCosmoMath.RNG
    ) -> typing.Tuple[float, float]: ...
    @staticmethod
    def id() -> int: ...
    def prepare(self, data: GalaxySDShapeIntrinsicData) -> None: ...
    def ref(self) -> GalaxySDShapeIntrinsic: ...

class GalaxySDShapeIntrinsicBeta(GalaxySDShapeIntrinsic):
    r"""
    :Constructors:

    ::

        GalaxySDShapeIntrinsicBeta(**properties)
        new() -> NumCosmo.GalaxySDShapeIntrinsicBeta

    Object NcGalaxySDShapeIntrinsicBeta

    Properties from NcGalaxySDShapeIntrinsicBeta:
      mu -> gdouble: mu
        \mu
      nu -> gdouble: nu
        \nu
    ...
    @staticmethod
    def clear(gsib: GalaxySDShapeIntrinsicBeta) -> None: ...
    def free(self) -> None: ...
    @classmethod
    def new(cls) -> GalaxySDShapeIntrinsicBeta: ...
    def ref(self) -> GalaxySDShapeIntrinsicBeta: ...

class GalaxySDShapeIntrinsicBetaClass(GObject.GPointer):
    r"""
    :Constructors:

    ::

        GalaxySDShapeIntrinsicBetaClass()
    """

    parent_class: GalaxySDShapeIntrinsicClass = ...

class GalaxySDShapeIntrinsicClass(GObject.GPointer):
    r"""
    :Constructors:

    ::

        GalaxySDShapeIntrinsicClass()
    """

    parent_class: NumCosmoMath.ModelClass = ...
    data_init: typing.Callable[
        [GalaxySDShapeIntrinsic, GalaxySDShapeIntrinsicData], None
    ] = ...
    prepare: typing.Callable[
        [GalaxySDShapeIntrinsic, GalaxySDShapeIntrinsicData], None
    ] = ...
    eval_residual: typing.Callable[
        [GalaxySDShapeIntrinsic, GalaxySDShapeIntrinsicData, float], float
    ] = ...
    gen: typing.Callable[
        [GalaxySDShapeIntrinsic, GalaxySDShapeIntrinsicData, NumCosmoMath.RNG],
        typing.Tuple[float, float],
    ] = ...
    e_rms: typing.Callable[
        [GalaxySDShapeIntrinsic, GalaxySDShapeIntrinsicData], float
    ] = ...
    padding: list[None] = ...

class GalaxySDShapeIntrinsicData(GObject.GBoxed):
    r"""
    :Constructors:

    ::

        GalaxySDShapeIntrinsicData()
        new(gsi:NumCosmo.GalaxySDShapeIntrinsic) -> NumCosmo.GalaxySDShapeIntrinsicData
    """
    ...
    ldata_destroy: typing.Callable[[None], None] = ...
    ldata_read_row: typing.Callable[
        [GalaxySDShapeIntrinsicData, GalaxyWLObs, int], None
    ] = ...
    ldata_write_row: typing.Callable[
        [GalaxySDShapeIntrinsicData, GalaxyWLObs, int], None
    ] = ...
    ...
    ref_count: int = ...
    @classmethod
    def new(cls, gsi: GalaxySDShapeIntrinsic) -> GalaxySDShapeIntrinsicData: ...
    def read_row(self, obs: GalaxyWLObs, i: int) -> None: ...
    def ref(self) -> GalaxySDShapeIntrinsicData: ...
    def required_columns(self) -> list[str]: ...
    def unref(self) -> None: ...
    def write_row(self, obs: GalaxyWLObs, i: int) -> None: ...

class GalaxySDShapeIntrinsicGauss(GalaxySDShapeIntrinsic):
    r"""
    :Constructors:

    ::

        GalaxySDShapeIntrinsicGauss(**properties)
        new() -> NumCosmo.GalaxySDShapeIntrinsicGauss

    Object NcGalaxySDShapeIntrinsicGauss

    Properties from NcGalaxySDShapeIntrinsicGauss:
      sigma -> gdouble: sigma
        \sigma
      sigma-fit -> gboolean: sigma-fit
        \sigma:fit
    ...
    @staticmethod
    def clear(gsig: GalaxySDShapeIntrinsicGauss) -> None: ...
    def free(self) -> None: ...
    @classmethod
    def new(cls) -> GalaxySDShapeIntrinsicGauss: ...
    def ref(self) -> GalaxySDShapeIntrinsicGauss: ...

class GalaxySDShapeIntrinsicGaussClass(GObject.GPointer):
    r"""
    :Constructors:

    ::

        GalaxySDShapeIntrinsicGaussClass()
    """
...
class GalaxySDTrueRedshift(NumCosmoMath.Model):
    ...
    def ln_integ(self, z: float) -> float: ...
...
class GalaxyWLObs(NumCosmoMath.Catalog):
    ...
    ::
        ...
        new(ellip_conv:NumCosmo.GalaxyWLObsEllipConv, coord:NumCosmo.WLEllipticityFrame, nrows:int, col_names:list) -> NumCosmo.GalaxyWLObs
    ...
    Properties from NcGalaxyWLObs:
      pz -> NcmObjDictInt: P(z)
        P(z) splines
      coord -> NcWLEllipticityFrame: Coordinate system
    ...
    def get_coord(self) -> WLEllipticityFrame: ...
    def get_ellip_conv(self) -> GalaxyWLObsEllipConv: ...
    ...
    def set_coord(self, coord: WLEllipticityFrame) -> None: ...
...
class HICosmoDEWSpline(HICosmoDE):
    ...
    def lp_norm(self, ctype: NumCosmoMath.SplineCurvatureType, p: float) -> float: ...
...
class HIPertGW(NumCosmoMath.CSQ1D):
    ...
    def eval_powspec_at(self, model: NumCosmoMath.Model, tau: float) -> float: ...
    def free(self) -> None: ...
    def get_k(self) -> float: ...
    @classmethod
...
class HIPertITwoFluidsState(GObject.GBoxed):
    ...
    def eval_mode(
        self, obs_mode: HIPertITwoFluidsObsMode, obs: HIPertITwoFluidsObs
    ) -> NumCosmoMath.Complex: ...
    def eval_obs(
        self,
...
class HIPertITwoFluidsWKB(GObject.GBoxed):
    ...
    def free(self) -> None: ...
    def peek_state(self) -> HIPertITwoFluidsState: ...
...
class HIPertTwoFluids(HIPert):
    ...
    def compute_spectra(
        self,
        cosmo: HICosmo,
        alpha_a: typing.Sequence[float] | npt.NDArray[np.float64],
        k_a: typing.Sequence[float] | npt.NDArray[np.float64],
        logger: typing.Optional[typing.Callable[[int, int], None]] = None,
    ) -> list[HIPertTwoFluidsStateInterp]: ...
...
class HaloCMBhattacharya13(HaloMassSummary):
    r"""
    :Constructors:
    ...
    Properties from NcHaloCMBhattacharya13:
      growth-function -> NcGrowthFunc: growth-function
        Growth function
      mass-function -> NcHaloMassFunction: mass-function
        Halo mass function
    ...
    @staticmethod
    def clear(hcmb: HaloCMBhattacharya13) -> None: ...
    def free(self) -> None: ...
    @classmethod
    def new(
        cls,
...
class HaloCMBhattacharya13Class(GObject.GPointer):
    r"""
    :Constructors:

    ::

        HaloCMBhattacharya13Class()
    """

    parent_class: HaloMassSummaryClass = ...

class HaloCMDiemer15(HaloMassSummary):
    r"""
    :Constructors:
    ...
    Properties from NcHaloCMDiemer15:
      mass-function -> NcHaloMassFunction: mass-function
        Halo mass function
      log10MDelta -> gdouble: log10MDelta
        \log_{10}(M_{\Delta})
...
class HaloCMDutton14(HaloMassSummary):
    r"""
    :Constructors:

    ::

        HaloCMDutton14(**properties)
        new(mdef:NumCosmo.HaloMassSummaryMassDef, Delta:float) -> NumCosmo.HaloCMDutton14

    Object NcHaloCMDutton14

    Properties from NcHaloCMDutton14:
      log10MDelta -> gdouble: log10MDelta
        \log_{10}(M_{\Delta})
      log10MDelta-fit -> gboolean: log10MDelta-fit
        \log_{10}(M_{\Delta}):fit
    ...
    @staticmethod
    def clear(hcmdm: HaloCMDutton14) -> None: ...
    def free(self) -> None: ...
    @classmethod
    def new(cls, mdef: HaloMassSummaryMassDef, Delta: float) -> HaloCMDutton14: ...
    def ref(self) -> HaloCMDutton14: ...

class HaloCMDutton14Class(GObject.GPointer):
    r"""
    :Constructors:
...
class HaloCMPrada12(HaloMassSummary):
    r"""
    :Constructors:
    ...
    Properties from NcHaloCMPrada12:
      mass-function -> NcHaloMassFunction: mass-function
        Halo mass function
      log10MDelta -> gdouble: log10MDelta
        \log_{10}(M_{\Delta})
...
class MultiplicityFuncBhattacharya(MultiplicityFunc):
    ...
    ::
        ...
        new_full(convention:NumCosmo.MultiplicityFuncBhattacharyaConvention) -> NumCosmo.MultiplicityFuncBhattacharya
    ...
    Properties from NcMultiplicityFuncBhattacharya:
      ...
      critical-delta -> gdouble: critical-delta
        Critical delta
      convention -> NcMultiplicityFuncBhattacharyaConvention: convention
    ...
    class Props:
        A: float
        a: float
        convention: MultiplicityFuncBhattacharyaConvention
        critical_delta: float
        p: float
        q: float
        Delta: float
    ...
    def get_A(self) -> float: ...
    def get_a(self) -> float: ...
    def get_convention(self) -> MultiplicityFuncBhattacharyaConvention: ...
    def get_delta_c(self) -> float: ...
    def get_p(self) -> float: ...
    ...
    @classmethod
    def new_full(
        cls, convention: MultiplicityFuncBhattacharyaConvention
    ) -> MultiplicityFuncBhattacharya: ...
    def ref(self) -> MultiplicityFuncBhattacharya: ...
    def set_A(self, A: float) -> None: ...
    def set_a(self, a: float) -> None: ...
    def set_convention(
        self, convention: MultiplicityFuncBhattacharyaConvention
    ) -> None: ...
    def set_delta_c(self, delta_c: float) -> None: ...
    def set_p(self, p: float) -> None: ...
...
class TransferFuncEHNoBaryon(TransferFunc):
    r"""
    :Constructors:

    ::

        TransferFuncEHNoBaryon(**properties)
        new() -> NumCosmo.TransferFunc

    Object NcTransferFuncEHNoBaryon
    ...
    @classmethod
    def new(cls) -> TransferFuncEHNoBaryon: ...

class TransferFuncEHNoBaryonClass(GObject.GPointer):
    r"""
    :Constructors:

    ::

        TransferFuncEHNoBaryonClass()
    """
...
class ClusterMassExtSParams(GObject.GEnum):
    MU_P0: ClusterMassExtSParams = ...
    MU_P1: ClusterMassExtSParams = ...
    MU_P2: ClusterMassExtSParams = ...
    MU_P3: ClusterMassExtSParams = ...
    SIGMA_P0: ClusterMassExtSParams = ...
    SIGMA_P1: ClusterMassExtSParams = ...
    SIGMA_P2: ClusterMassExtSParams = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class ClusterMassRichnessSParams(GObject.GEnum):
    CUT: ClusterMassRichnessSParams = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class DataSNIACovError(GObject.GEnum):
    ...
    UNAVAILABLE_RESAMPLE: DataSNIACovError = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class DataSNIACovResample(GObject.GEnum):
    AUTO: DataSNIACovResample = ...
    FROM_COV: DataSNIACovResample = ...
    FROM_LIGHTCURVE: DataSNIACovResample = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class GalaxySDShapeIntrinsicBetaParams(GObject.GEnum):
    MU: GalaxySDShapeIntrinsicBetaParams = ...
    NU: GalaxySDShapeIntrinsicBetaParams = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class GalaxySDShapeIntrinsicGaussParams(GObject.GEnum):
    SIGMA: GalaxySDShapeIntrinsicGaussParams = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class HIPertITwoFluidsObs(GObject.GEnum):
    ...
    PZETA: HIPertITwoFluidsObs = ...
    ZETA: HIPertITwoFluidsObs = ...
    ZETA_DIFF: HIPertITwoFluidsObs = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class HaloCMBhattacharya13SParams(GObject.GEnum):
    DELTA: HaloCMBhattacharya13SParams = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class HaloCMDiemer15SParams(GObject.GEnum):
    DELTA: HaloCMDiemer15SParams = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class HaloCMDutton14SParams(GObject.GEnum):
    DELTA: HaloCMDutton14SParams = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class HaloCMPrada12SParams(GObject.GEnum):
    DELTA: HaloCMPrada12SParams = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class MultiplicityFuncBhattacharyaConvention(GObject.GEnum):
    BHATTACHARYA2011: MultiplicityFuncBhattacharyaConvention = ...
    HEITMANN2019: MultiplicityFuncBhattacharyaConvention = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class WLEllipticityFrame(GObject.GEnum):
    CARTESIAN: WLEllipticityFrame = ...
    CELESTIAL: WLEllipticityFrame = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...

...
class GalaxySDObsRedshiftClass(GObject.GPointer):
    ...
    data_init: Callable[[GalaxySDObsRedshift, GalaxySDObsRedshiftData], None] = ...
    padding: list[None] = ...
...
class HaloDensityProfile(NumCosmoMath.Model):
    ...
    def get_numint_splines(self) -> Tuple[NumCosmoMath.Spline, NumCosmoMath.Spline]: ...
...
class HaloMassConcentrationParamSParams(GObject.GEnum):
    C_DELTA: HaloMassConcentrationParamSParams = ...
    LOG10M_DELTA: HaloMassConcentrationParamSParams = ...

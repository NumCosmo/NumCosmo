...
def lapack_dggglm_run(
    ws: typing.Sequence[float], L: Matrix, X: Matrix, p: Vector, d: Vector, y: Vector
) -> int: ...
def lapack_dposv(
...
class ABCClass(GObject.GPointer):
    ...
    data_summary: typing.Callable[[ABC], bool] = ...
    mock_distance: typing.Callable[[ABC, Dataset, Vector, Vector, RNG], float] = ...
    distance_prob: typing.Callable[[ABC, float], float] = ...
    update_tkern: typing.Callable[[ABC], None] = ...
    get_desc: typing.Callable[[ABC], str] = ...
    log_info: typing.Callable[[ABC], str] = ...
    padding: list[None] = ...
...
class Fit(GObject.Object):
    ...
    def params_set_array(self, x: typing.Sequence[float]) -> None: ...
...
class HOAA(GObject.Object):
    ...
    def do_eval_V(self, model: typing.Optional[Model], t: float, k: float) -> float: ...
    def do_eval_dlnmnu(
        self, model: typing.Optional[Model], t: float, k: float
    ) -> float: ...
    def do_eval_mnu(
        self, model: typing.Optional[Model], t: float, k: float
    ) -> float: ...
    ...
    def do_eval_powspec_factor(self, model: typing.Optional[Model] = None) -> float: ...
    def do_eval_sing_V(
        self, model: typing.Optional[Model], t_m_ts: float, k: float, sing: int
    ) -> float: ...
    ...
    def do_get_sing_info(
        self, model: typing.Optional[Model], k: float, sing: int
    ) -> typing.Tuple[float, float, float, HOAASingType]: ...
    def do_nsing(self, model: typing.Optional[Model], k: float) -> int: ...
    def do_prepare(self, model: typing.Optional[Model] = None) -> None: ...
    def eval_AA(
        self, model: typing.Optional[Model], t: float
    ) -> typing.Tuple[float, float, float, float]: ...
    def eval_AA2QV(
        self,
        model: typing.Optional[Model],
    ...
    def eval_V(self, model: typing.Optional[Model], t: float, k: float) -> float: ...
    def eval_adiabatic_LnI_approx(
        self, model: typing.Optional[Model], t: float, theta: float, psi: float
    ) -> typing.Tuple[float, float]: ...
    ...
    def eval_mnu(self, model: typing.Optional[Model], t: float, k: float) -> float: ...
    def eval_nu(self, model: typing.Optional[Model], t: float, k: float) -> float: ...
    def eval_powspec_factor(self, model: typing.Optional[Model] = None) -> float: ...
    def eval_sing_V(
        self, model: typing.Optional[Model], t_m_ts: float, k: float, sing: int
    ) -> float: ...
    ...
    def eval_solution(
        self, model: typing.Optional[Model], t: float, S: float, PS: float
    ) -> typing.Tuple[float, float]: ...
    def eval_system(
        self, model: typing.Optional[Model], t: float, k: float
    ) -> typing.Tuple[float, float, float]: ...
    ...
    def nsing(self, model: typing.Optional[Model], k: float) -> int: ...
    def prepare(self, model: typing.Optional[Model] = None) -> None: ...
    def ref(self) -> HOAA: ...
...
class HOAAClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    eval_mnu: typing.Callable[[HOAA, typing.Optional[Model], float, float], float] = ...
    eval_nu: typing.Callable[[HOAA, typing.Optional[Model], float, float], float] = ...
    eval_dlnmnu: typing.Callable[
        [HOAA, typing.Optional[Model], float, float], float
    ] = ...
    eval_V: typing.Callable[[HOAA, typing.Optional[Model], float, float], float] = ...
    eval_system: typing.Callable[
        [HOAA, typing.Optional[Model], float, float], typing.Tuple[float, float, float]
    ] = ...
    nsing: typing.Callable[[HOAA, typing.Optional[Model], float], int] = ...
    get_sing_info: typing.Callable[
        [HOAA, typing.Optional[Model], float, int],
        typing.Tuple[float, float, float, HOAASingType],
    ] = ...
    eval_sing_mnu: typing.Callable[
        [HOAA, typing.Optional[Model], float, float, int], float
    ] = ...
    eval_sing_dlnmnu: typing.Callable[
        [HOAA, typing.Optional[Model], float, float, int], float
    ] = ...
    eval_sing_V: typing.Callable[
        [HOAA, typing.Optional[Model], float, float, int], float
    ] = ...
    eval_sing_system: typing.Callable[
        [HOAA, typing.Optional[Model], float, float, int],
        typing.Tuple[float, float, float],
    ] = ...
    eval_powspec_factor: typing.Callable[[HOAA, typing.Optional[Model]], float] = ...
    prepare: typing.Callable[[HOAA, typing.Optional[Model]], None] = ...
    padding: list[None] = ...
...
class MSet(GObject.Object):
    ...
    def fparams_set_array(self, x: typing.Sequence[float]) -> None: ...
    ...
    def param_get_pi(
        self, pi: typing.Sequence[MSetPIndex], x: typing.Sequence[float]
    ) -> None: ...
...
class MSetCatalog(GObject.Object):
    ...
    def add_from_mset_array(self, mset: MSet, ax: typing.Sequence[float]) -> None: ...
    def add_from_vector(self, vals: Vector) -> None: ...
    def add_from_vector_array(
        self, vals: Vector, ax: typing.Sequence[float]
    ) -> None: ...
    ...
    def calc_ci_direct(
        self, func: MSetFunc, x_v: Vector, p_val: typing.Sequence[float]
    ) -> Matrix: ...
    def calc_ci_interp(
        self,
        func: MSetFunc,
        x_v: Vector,
        p_val: typing.Sequence[float],
        nodes: int,
        mtype: FitRunMsgs,
    ) -> Matrix: ...
...
class MSetFunc(GObject.Object):
    ...
    def do_eval(
        self, mset: MSet, x: typing.Sequence[float], res: typing.Sequence[float]
    ) -> None: ...
    def eval(
        self, mset: MSet, x: typing.Sequence[float], res: typing.Sequence[float]
    ) -> None: ...
    ...
    def numdiff_fparams(self, mset: MSet, x: typing.Sequence[float]) -> Vector: ...
    def peek_desc(self) -> str: ...
    def peek_name(self) -> str: ...
    ...
    def set_eval_x(self, x: typing.Sequence[float]) -> None: ...
    def set_meta(
...
class MSetFunc1(MSetFunc):
    ...
    def do_eval1(self, mset: MSet, x: typing.Sequence[float]) -> list[float]: ...
    def eval1(self, mset: MSet, x: typing.Sequence[float]) -> list[float]: ...
    def free(self) -> None: ...
...
class MSetFunc1Class(GObject.GPointer):
    ...
    eval1: typing.Callable[[MSetFunc1, MSet, typing.Sequence[float]], list[float]] = ...
    padding: list[None] = ...
...
class MSetFuncClass(GObject.GPointer):
    ...
    eval: typing.Callable[
        [MSetFunc, MSet, typing.Sequence[float], typing.Sequence[float]], None
    ] = ...
    padding: list[None] = ...
...
class Matrix(GObject.Object):
    ...
    @classmethod
    def new_array(cls, a: typing.Sequence[float], ncols: int) -> Matrix: ...
    @classmethod
    def new_full(
        cls,
        d: float,
    ...
    def set_from_array(self, a: typing.Sequence[float]) -> None: ...
    def set_from_data(self, data: typing.Sequence[float]) -> None: ...
...
class Model(GObject.Object):
    ...
    def ref(self) -> Model: ...
    def set_name_nick(*args, **kwargs): ...  # FIXME Function
    def set_reparam(self, reparam: Reparam) -> None: ...
    def set_sparam(*args, **kwargs): ...  # FIXME Function
    def set_sparam_obj(*args, **kwargs): ...  # FIXME Function
    def set_vparam(*args, **kwargs): ...  # FIXME Function
    def set_vparam_len(self, n: int, len: int) -> None: ...
    def set_vparam_obj(*args, **kwargs): ...  # FIXME Function
...
class RNG(GObject.Object):
    ...
    def lock(self) -> None: ...
    def multinomial(
        self, N: int, p: typing.Sequence[float], n: typing.Sequence[int]
    ) -> None: ...
    @classmethod
...
class RNGDiscrete(GObject.GBoxed):
    ...
    def free(self) -> None: ...
    @classmethod
    def new(cls, weights: typing.Sequence[float]) -> RNGDiscrete: ...
...
class SFSphericalHarmonics(GObject.Object):
    ...
    def start_rec_array(
        self, sphaYa: SFSphericalHarmonicsYArray, theta: typing.Sequence[float]
    ) -> None: ...
...
class SphereMap(GObject.Object):
    ...
    def set_lmax(self, lmax: int) -> None: ...
    def set_map(self, map: typing.Sequence[float]) -> None: ...
...
class Spline(GObject.Object):
    ...
    def new_array(
        self, x: typing.Sequence[float], y: typing.Sequence[float], init: bool
    ) -> Spline: ...
...
class VarDict(GObject.GBoxed):
    ...
    def set_double_array(self, key: str, value: typing.Sequence[float]) -> None: ...
...
class Vector(GObject.Object):
    ...
    @classmethod
    def const_new_data(
        cls, d: typing.Sequence[float], size: int, stride: int
    ) -> Vector: ...
    @classmethod
    ...
    @classmethod
    def new_array(cls, a: typing.Sequence[float]) -> Vector: ...
    @classmethod
    def new_data_dup(
        cls, d: typing.Sequence[float], size: int, stride: int
    ) -> Vector: ...
    ...
    def set_all(self, val: float) -> None: ...
    def set_array(self, array: typing.Sequence[float]) -> None: ...
    def set_data(self, array: typing.Sequence[float]) -> None: ...
    def set_from_variant(self, var: GLib.Variant) -> None: ...
    def set_zero(self) -> None: ...
    def sqrt(self) -> None: ...

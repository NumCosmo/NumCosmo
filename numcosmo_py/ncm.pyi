...
class SBesselOdeSolverIVP(GObject.Object):
    r"""
    :Constructors:

    ::

        SBesselOdeSolverIVP(**properties)
        new() -> NumCosmoMath.SBesselOdeSolverIVP

    Object NcmSBesselOdeSolverIVP

    Properties from NcmSBesselOdeSolverIVP:
      reltol -> gdouble: reltol
        Relative integration tolerance
      abstol -> gdouble: abstol
        Absolute integration tolerance
      method -> NcmSBesselOdeSolverIVPMethod: method
        IVP numerical formulation
    ...
    class Props:
        abstol: float
        method: SBesselOdeSolverIVPMethod
        reltol: float
    ...
    @staticmethod
    def clear(solver: SBesselOdeSolverIVP) -> None: ...
    def free(self) -> None: ...
    def get_abstol(self) -> float: ...
    def get_method(self) -> SBesselOdeSolverIVPMethod: ...
    def get_reltol(self) -> float: ...
    @classmethod
    def new(cls) -> SBesselOdeSolverIVP: ...
    def ref(self) -> SBesselOdeSolverIVP: ...
    def set_abstol(self, abstol: float) -> None: ...
    def set_method(self, method: SBesselOdeSolverIVPMethod) -> None: ...
    def set_reltol(self, reltol: float) -> None: ...
    def solve(
        self,
        f: typing.Optional[typing.Callable[..., float]],
        xi: float,
        xf: float,
        ell: int,
        *user_data: typing.Any,
...
class SBesselOdeSolverIVPClass(GObject.GPointer):
    r"""
    :Constructors:

    ::

        SBesselOdeSolverIVPClass()
    """
...
class SBesselOdeSolverIVPMethod(GObject.GEnum):
    FROBENIUS: SBesselOdeSolverIVPMethod = ...
    STANDARD: SBesselOdeSolverIVPMethod = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...

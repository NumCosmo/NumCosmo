...
class Fit(GObject.Object):
    ...
    @staticmethod
    def factory(ftype: FitType, algo_name: str, lh: Likelihood, mset: MSet, gtype: FitGradType) -> Fit: ...
...
class FitNLOpt(Fit):
    ...
    def __init__(self, algorithm: FitNloptAlgorithm = ...,
                 ...
                 sub_fit: Fit = ...): ...
    @classmethod
    def local_new(cls, lh: Likelihood, mset: MSet, gtype: FitGradType, algo: FitNloptAlgorithm, local_algo: FitNloptAlgorithm) -> FitNLOpt: ...
    @classmethod
    def new(cls, lh: Likelihood, mset: MSet, gtype: FitGradType, algo: FitNloptAlgorithm) -> FitNLOpt: ...
    @classmethod
...
class ODEEval(GObject.Object):
    ...
    priv: ODEEvalPrivate = ...
    def __init__(self, sys_size: int = ...): ...
    def J_dense(self, t: float, f: Sequence[float], J_col: Sequence[float]) -> int: ...
    @staticmethod
    def clear(ode_eval: ODEEval) -> None: ...
    def df(self, t: float, f: Sequence[float]) -> Tuple[int, list[float]]: ...
    def do_J_dense(self, t: float, f: Sequence[float], J_col: Sequence[float]) -> int: ...
    def do_clean_ls(self) -> None: ...
    def do_df(self, t: float, f: Sequence[float]) -> Tuple[int, list[float]]: ...
    def free(self) -> None: ...
...
class ODEEvalClass(GObject.GPointer):
    ...
    """
    parent_class: GObject.ObjectClass = ...
    df: Callable[[ODEEval, float, Sequence[float]], Tuple[int, list[float]]] = ...
    J_dense: Callable[[ODEEval, float, Sequence[float], Sequence[float]], int] = ...
...
class SFSphericalHarmonics(GObject.Object):
    ...
    def start_rec_array(self, sphaYa: SFSphericalHarmonicsYArray, theta: Sequence[float]) -> None: ...

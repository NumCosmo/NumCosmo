...
class FitESMCMCWalkerAPES(FitESMCMCWalker):
    ...
    Properties from NcmFitESMCMCWalkerAPES:
      ...
      exploration-patience -> guint: exploration-patience
    ...
    def get_exploration_patience(self) -> int: ...
    ...
    def set_exploration_patience(self, patience: int) -> None: ...

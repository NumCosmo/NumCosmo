...
class SBesselOdeSolver(GObject.Object):
    ...
    def get_operator_matrix_colmajor(self, nrows: int) -> Matrix: ...
    def get_rational_rhs(
        self, center: float, std: float, k: float, N: int
    ) -> Vector: ...
    def get_solution_size(self) -> int: ...
    def get_tolerance(self) -> float: ...
    def integrate(
        self, F: typing.Callable[..., float], N: int, *user_data: typing.Any
    ) -> float: ...
    def integrate_gaussian(
        self, center: float, std: float, k: float, N: int
    ) -> float: ...
    ...
    def solve_endpoints_batched(
        self, rhs: Vector, lmin: int, n_l: int, endpoints: Matrix
    ) -> None: ...

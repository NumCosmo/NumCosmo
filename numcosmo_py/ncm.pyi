...
class LaurentSeries(GObject.GBoxed):
    ...
    def eval(self, w: Complex) -> Complex: ...
    def free(self) -> None: ...
    def get(self, h: int, out: Complex) -> None: ...
    def hmax(self) -> int: ...
    def hmin(self) -> int: ...
    ...
    def scale(self, s: Complex) -> LaurentSeries: ...
    def set(self, h: int, val: Complex) -> None: ...
...
class LaurentSeriesTPS(GObject.GBoxed):
    ...
    def eval(self, w: Complex, g: Complex) -> Complex: ...

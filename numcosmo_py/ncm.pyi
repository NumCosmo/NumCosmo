...
class FunctionSampleSet(GObject.Object):
    ...
    def free(self) -> None: ...
    def get_interval_ok(self, index: int) -> int: ...
    def get_len(self) -> int: ...
    def get_nsamples(self) -> int: ...
    def get_sample(self, index: int) -> typing.Tuple[float, Vector, int]: ...
    def inc_interval_ok(self, index: int) -> None: ...
    def insert_after(self, index: int, x: float, y: Vector) -> None: ...
    def insert_after_func(
        self,
        index: int,
        x: float,
        f: typing.Callable[..., None],
    ...
    def insert_before(self, index: int, x: float, y: Vector) -> None: ...
    def insert_before_func(
        self,
        index: int,
        x: float,
        f: typing.Callable[..., None],
    ...
    def peek_x(self, index: int) -> float: ...
    def peek_y(self, index: int) -> Vector: ...
    ...
    def set_interval_ok(self, index: int, interval_ok: int) -> None: ...

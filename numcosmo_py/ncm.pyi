...
FIT_ESMCMC_LRE_MAX_TAU_ROUNDS: int = 20
...
MSET_CATALOG_HDU0_FUNCTIONS_KEY: str = r"functions"
MSET_CATALOG_HDU0_MSET_KEY: str = r"model-set"
MSET_CATALOG_INIT_SAMPLER_LABEL: str = r"INITSMP"
...
MSET_CATALOG_MARKOVIAN_ID_LABEL: str = r"MARKID"
MSET_CATALOG_MSET_FORMAT_LABEL: str = r"MSETFMT"
MSET_CATALOG_MSET_FORMAT_OBJECT: str = r"gvariant"
MSET_CATALOG_MSET_FORMAT_VARDICT: str = r"vardict"
...
MSET_CATALOG_SAMPLER_LABEL: str = r"SAMPLER"
MSET_CATALOG_SAMPLER_OPTS_LABEL: str = r"SAMPOPT"
...
SBESSEL_INTEGRATOR_LEVIN_DEFAULT_TAU_CONSTRAINT_GUARD: float = 10.0
SBESSEL_INTEGRATOR_LEVIN_DEFAULT_TAU_CONSTRAINT_MIN_OSC: float = 50.0
...
STATS_ACORR_DEFAULT_DRIFT_THRESHOLD: float = 3.0
STATS_ACORR_DEFAULT_MAX_LAG: int = 512
STATS_ACORR_DEFAULT_MAX_LEVELS: int = 24
STATS_ACORR_DEFAULT_RELIABILITY_FACTOR: float = 50.0
STATS_ACORR_SOKAL_C: float = 5.0
STATS_ACORR_VARIANCE_SHIFT_FACTOR: float = 100.0
...
def cfg_register_functions() -> None: ...
def cfg_register_obj(obj: typing.Type[typing.Any]) -> None: ...
def cfg_register_objects() -> None: ...
...
def laurent_series_clear(a: LaurentSeries) -> None: ...
def laurent_series_tps_clear(tps: LaurentSeriesTPS) -> None: ...
...
def poly_roots_real_cubic(
    a: typing.Sequence[float] | npt.NDArray[np.float64],
) -> typing.Tuple[int, list[float]]: ...
def poly_roots_real_quadratic(
    a: typing.Sequence[float] | npt.NDArray[np.float64],
) -> typing.Tuple[int, list[float]]: ...
def poly_roots_real_quartic(
    a: typing.Sequence[float] | npt.NDArray[np.float64],
) -> typing.Tuple[int, list[float]]: ...
def poly_roots_real_quartic_or_lower(
    a: typing.Sequence[float] | npt.NDArray[np.float64],
) -> typing.Tuple[int, list[float]]: ...
def sbessel_ode_operator_clear(op: SBesselOdeOperator) -> None: ...
...
def stats_acorr_diag_to_string(diag: StatsAcorrDiag) -> str: ...
...
class CSQ1D(GObject.Object):
    ...
    def do_eval_int_nu(self, model: typing.Optional[Model], t: float) -> float: ...
    ...
    def eval_delta_theta_at(self, t: float) -> float: ...
    ...
    def eval_int_nu(self, model: typing.Optional[Model], t: float) -> float: ...
    ...
    def prepare_phase_splines(self, model: typing.Optional[Model] = None) -> None: ...
    def prepare_prop(
...
class CSQ1DClass(GObject.GPointer):
    ...
    eval_int_nu: typing.Callable[[CSQ1D, typing.Optional[Model], float], float] = ...
...
class Catalog(GObject.Object):
    ...
    ::
        ...
        Catalog(**properties)
        new(nrows:int, col_names:list) -> NumCosmoMath.Catalog
        new_full(nrows:int, col_names:list, col_types:list) -> NumCosmoMath.Catalog
    ...
    def get_bool(self, col: str, i: int) -> bool: ...
    def get_col_type(self, col: str) -> CatalogColType: ...
    def get_index(self, col: str) -> typing.Tuple[bool, int]: ...
    def get_int(self, col: str, i: int) -> int: ...
    def has_column(self, col: str) -> bool: ...
    def len(self) -> int: ...
    def ncols(self) -> int: ...
    @classmethod
    def new(cls, nrows: int, col_names: typing.Sequence[str]) -> Catalog: ...
    @classmethod
    def new_full(
        cls,
        nrows: int,
        col_names: typing.Sequence[str],
        col_types: typing.Sequence[CatalogColType],
    ) -> Catalog: ...
...
class Data(GObject.Object):
    ...
    def do_register_shared(self, ser: Serialize) -> None: ...
    ...
    def ref(self) -> Data: ...
    def register_shared(self, ser: Serialize) -> None: ...
...
class DataClass(GObject.GPointer):
    ...
    register_shared: typing.Callable[[Data, Serialize], None] = ...
    padding: list[None] = ...
...
class DataGaussDiag(Data):
    ...
    def do_mean_func(self, mset: MSet, vp: Vector) -> None: ...
    def do_set_size(self, np: int) -> None: ...
    def do_sigma_func(self, mset: MSet, sigma: Vector) -> bool: ...
    def get_size(self) -> int: ...
    def peek_mean(self) -> Vector: ...
...
class FitESMCMCWalker(GObject.Object):
    ...
    def do_end_run(self) -> None: ...
    def do_get_nparams(self) -> int: ...
    def do_get_size(self) -> int: ...
    def do_is_markovian(self) -> bool: ...
    def do_opts(self) -> typing.Optional[str]: ...
    def do_prob(
        self,
    ...
    def do_start_run(self, initial: bool, exploration_done: int) -> None: ...
    def do_step(
        self,
        theta: typing.Sequence[Vector],
        m2lnL: typing.Sequence[Vector],
    ...
    def opts(self) -> typing.Optional[str]: ...
    def prob(
        self,
        theta: typing.Sequence[Vector],
        m2lnL: typing.Sequence[Vector],
    ...
    def start_run(self, initial: bool, exploration_done: int) -> None: ...
    def step(
        self,
        theta: typing.Sequence[Vector],
        m2lnL: typing.Sequence[Vector],
...
class FitESMCMCWalkerAPES(FitESMCMCWalker):
    ...
    ::
        ...
        new_full(nwalkers:int, nparams:int, method:NumCosmoMath.FitESMCMCWalkerAPESMethod, k_type:NumCosmoMath.FitESMCMCWalkerAPESKType, over_smooth:float) -> NumCosmoMath.FitESMCMCWalkerAPES
    ...
    Properties from NcmFitESMCMCWalkerAPES:
      ...
      exploration-stop-after -> guint: exploration-stop-after
    ...
    class Props:
        ...
        exploration: int
        exploration_qratio_floor: float
        exploration_stop_after: int
    ...
    def get_exploration(self) -> int: ...
    def get_exploration_qratio_floor(self) -> float: ...
    def get_exploration_stop_after(self) -> int: ...
    ...
    def set_exploration_qratio_floor(self, qratio_floor: float) -> None: ...
    def set_exploration_stop_after(self, stop_after: int) -> None: ...
...
class FitESMCMCWalkerClass(GObject.GPointer):
    ...
    opts: typing.Callable[[FitESMCMCWalker], typing.Optional[str]] = ...
    start_run: typing.Callable[[FitESMCMCWalker, bool, int], None] = ...
    end_run: typing.Callable[[FitESMCMCWalker], None] = ...
    is_markovian: typing.Callable[[FitESMCMCWalker], bool] = ...
    padding: list[None] = ...
...
class FunctionSampleSet(GObject.Object):
    r"""
    :Constructors:

    ::

        FunctionSampleSet(**properties)
        new(len:int) -> NumCosmoMath.FunctionSampleSet

    Object NcmFunctionSampleSet
    ...
    def add_old(self, x: float, y: Vector) -> None: ...
    def add_old_func(
        self, x: float, f: typing.Callable[..., None], *user_data: typing.Any
    ) -> None: ...
    ...
    def expand_domain(
        ...
        epsilon: float,
        max_iterations: int,
        consecutive_tries: int,
        *user_data: typing.Any,
    ) -> None: ...
    def free(self) -> None: ...
    def get_absmaxF(self, i: int) -> typing.Tuple[float, float]: ...
    def get_absmaxF_l2_norm(self) -> float: ...
    def get_absmaxF_linf_norm(self) -> float: ...
    ...
    def iter_end(self) -> FunctionSampleSetIter: ...
    def iter_insert_after(
        self, iter: FunctionSampleSetIter, x: float, y: Vector
    ) -> FunctionSampleSetIter: ...
    def iter_insert_after_func(
        self,
        iter: FunctionSampleSetIter,
        x: float,
        f: typing.Callable[..., None],
        *user_data: typing.Any,
    ) -> FunctionSampleSetIter: ...
    def iter_insert_before(
        self, iter: FunctionSampleSetIter, x: float, y: Vector
    ) -> FunctionSampleSetIter: ...
    def iter_insert_before_func(
        self,
        iter: FunctionSampleSetIter,
        x: float,
        f: typing.Callable[..., None],
    ...
    @classmethod
    def new(cls, len: int) -> FunctionSampleSet: ...
...
class FunctionSampleSetClass(GObject.GPointer):
    r"""
    :Constructors:

    ::

        FunctionSampleSetClass()
    """

    parent_class: GObject.ObjectClass = ...

class FunctionSampleSetIter(GObject.GBoxed):
    r"""
    :Constructors:
    ...
    node: list[None] = ...
    owner: FunctionSampleSet = ...
    def copy(self) -> FunctionSampleSetIter: ...
    def free(self) -> None: ...
    ...
    def inc_interval_ok(self) -> None: ...
    def is_valid(self) -> bool: ...
    def next(self) -> None: ...
    def next_pair(self) -> typing.Tuple[bool, FunctionSampleSetIter]: ...
    def prev(self) -> None: ...
    def set_interval_ok(self, interval_ok: int) -> None: ...
    def set_new_point(self, new_point: bool) -> None: ...
...
class IntegralFixed(GObject.GPointer):
    ...
    rule_n: int = ...
    def free(self) -> None: ...
    def get_nodes(self, nodes: Vector) -> None: ...
    def integ_vec_mult(self, f_at_nodes: Vector) -> float: ...
...
class LaurentSeries(GObject.GBoxed):
    r"""
    :Constructors:
    ...
    ::
        ...
        LaurentSeries()
        new(hmin:int, hmax:int) -> NumCosmoMath.LaurentSeries
    """
    ...
    c: Complex = ...
    ref_count: int = ...
    def add(self, b: LaurentSeries, sb: float) -> LaurentSeries: ...
    @staticmethod
    def clear(a: LaurentSeries) -> None: ...
    def conj(self) -> LaurentSeries: ...
    def conv(self, b: LaurentSeries) -> LaurentSeries: ...
    def copy(self) -> LaurentSeries: ...
    def eval_ptr(self, w: Complex) -> Complex: ...
    def free(self) -> None: ...
    def get_hmax(self) -> int: ...
    def get_hmin(self) -> int: ...
    def get_ptr(self, h: int, out: Complex) -> None: ...
    def jacobi_anger_reduce(
        self, phi: float, Ik: typing.Sequence[float] | npt.NDArray[np.float64]
    ) -> float: ...
    @classmethod
    def new(cls, hmin: int, hmax: int) -> LaurentSeries: ...
    def ref(self) -> LaurentSeries: ...
    def scale_ptr(self, s: Complex) -> LaurentSeries: ...
    def set_ptr(self, h: int, val: Complex) -> None: ...

class LaurentSeriesTPS(GObject.GBoxed):
    r"""
    :Constructors:

    ::

        new(order:int) -> NumCosmoMath.LaurentSeriesTPS
    """

    def add(self, a: LaurentSeriesTPS, b: LaurentSeriesTPS, sb: float) -> None: ...
    @staticmethod
    def clear(tps: LaurentSeriesTPS) -> None: ...
    def conj(self, a: LaurentSeriesTPS) -> None: ...
    def conv(self, a: LaurentSeriesTPS, b: LaurentSeriesTPS) -> None: ...
    def eval_ptr(self, w: Complex, g: Complex) -> Complex: ...
    def get(self, n: int) -> LaurentSeries: ...
    @classmethod
    def new(cls, order: int) -> LaurentSeriesTPS: ...
    def order(self) -> int: ...
    def pow(self, a: LaurentSeriesTPS, p: float) -> None: ...
    def ref(self) -> LaurentSeriesTPS: ...
    def unref(self) -> None: ...
...
class MSetCatalog(GObject.Object):
    ...
    Properties from NcmMSetCatalog:
      ...
      burnin -> glong: burnin
        Burn-in size
      markovian-id -> gint: markovian-id
      ...
      run-type-string -> gchararray: run-type-string
        Run type string
      sampler -> gchararray: sampler
        Description of the sampler that filled the rows
      sampler-options -> gchararray: sampler-options
        Tunable settings of the sampler that filled the rows
      initial-sampler -> gchararray: initial-sampler
    ...
    class Props:
        burnin: int
        filename: str
        initial_sampler: typing.Optional[str]
        m2lnp_var: int
        markovian_id: int
        mset: MSet
        ...
        run_type_string: str
        sampler: typing.Optional[str]
        sampler_options: typing.Optional[str]
        smode: MSetCatalogSync
        sync_interval: float
        tau_method: StatsAcorrMethod
        weighted: bool
    ...
    def get_ess(self, p: int) -> float: ...
    def get_first_id(self) -> int: ...
    def get_full_covar(self) -> Matrix: ...
    def get_initial_sampler(self) -> typing.Optional[str]: ...
    def get_keff(self, p: int) -> float: ...
    def get_m2lnp_var(self) -> int: ...
    def get_markovian_burnin(self) -> int: ...
    def get_markovian_id(self) -> int: ...
    ...
    def get_sampler(self) -> typing.Optional[str]: ...
    def get_sampler_options(self) -> typing.Optional[str]: ...
    def get_shrink_factor(self) -> float: ...
    def get_tau_diag(self, p: int) -> StatsAcorrDiag: ...
    def get_tau_method(self) -> StatsAcorrMethod: ...
    ...
    def peek_acorr(self) -> StatsAcorr: ...
    ...
    def peek_functions_array(self) -> typing.Optional[ObjArray]: ...
    @staticmethod
    def peek_info_from_file(filename: str) -> typing.Tuple[int, int, int]: ...
    @staticmethod
    def peek_markovian_id_from_file(filename: str) -> int: ...
    def peek_mset(self) -> MSet: ...
    ...
    def set_functions_array(
        self, functions: typing.Optional[ObjArray] = None
    ) -> None: ...
    ...
    def set_sampler_options(self, options: typing.Optional[str] = None) -> None: ...
    def set_sync_interval(self, interval: float) -> None: ...
    def set_sync_mode(self, smode: MSetCatalogSync) -> None: ...
    def set_tau_method(self, tau_method: StatsAcorrMethod) -> None: ...
    def sync(self, check: bool) -> None: ...
    def tau_needs_more(self) -> typing.Tuple[bool, int]: ...
...
class Matrix(GObject.Object):
    ...
    def chol_chi2_cols(
        self, theta: Vector, U: Matrix, work: Matrix, chi2: Vector
    ) -> None: ...
    def cholesky_decomp(self, UL: int) -> int: ...
    def cholesky_decomp_nearPD(
        self, decomp: Matrix, UL: int, maxiter: int
    ...
    def dsyrk(
        self, UL: int, Trans: int, alpha: float, A: Matrix, beta: float
    ) -> None: ...
    def dtrmm(
        self, Side: int, UL: int, TransA: int, alpha: float, A: Matrix
    ) -> None: ...
    def dtrmv(self, UL: int, Trans: int, v: Vector) -> None: ...
    def dtrsm(
        self, Side: int, UL: int, TransA: int, alpha: float, A: Matrix
    ) -> None: ...
    def dtrsv(self, UL: int, Trans: int, v: Vector) -> None: ...
    def dup(self) -> Matrix: ...
    ...
    def scale_cols(self, s: Vector) -> None: ...
    def scale_rows(self, s: Vector) -> None: ...
    ...
    def sub_row_vector(self, v: Vector) -> None: ...
    @staticmethod
    def substitute(
    ...
    def zero_triangle(self, UL: int) -> None: ...
...
class Model(GObject.Object):
    ...
    def add_submodels(self, submodel_slot_len: int) -> None: ...
    ...
    def param_index_from_name_full(
        self, param_name: str
    ) -> typing.Tuple[bool, Model, int]: ...
    ...
    def set_submodel(
        self,
        submodel_slot_id: int,
        name: str,
        symbol: str,
        submodel_type: typing.Type[typing.Any],
    ) -> None: ...
    def set_vparam(
        self,
        vparam_id: int,
...
class ModelClass(GObject.GPointer):
    ...
    sparam: list[None] = ...
    vparam: list[None] = ...
    submodel_slot_len: int = ...
    parent_submodel_slot_len: int = ...
    submodel_slot: list[None] = ...
    def add_params(
        self, sparam_len: int, vparam_len: int, nonparam_prop_len: int
    ) -> None: ...
    def add_submodels(self, submodel_slot_len: int) -> None: ...
...
class OdeSpline(GObject.Object):
    ...
    Properties from NcmOdeSpline:
      ...
      min-subdivisions -> guint: min-subdivisions
    ...
    def get_min_subdivisions(self) -> int: ...
    ...
    def set_min_subdivisions(self, min_subdivisions: int) -> None: ...
    def set_reltol(self, reltol: float) -> None: ...
...
class PLN1D(GObject.Object):
    ...
    def eval_range_sum(
        self, R_min: int, R_max: int, mu: float, sigma: float
    ) -> float: ...
    def eval_range_sum_lnp(
        self, R_min: int, R_max: int, mu: float, sigma: float
    ) -> float: ...
    def free(self) -> None: ...
...
class Powspec(GObject.Object):
    ...
    def deriv_k(self, model: typing.Optional[Model], z: float, k: float) -> float: ...
...
class PowspecClass(GObject.GPointer):
    ...
    deriv_k: typing.Callable[[Powspec, typing.Optional[Model], float, float], float] = (
        ...
    )
...
class SBesselIntegratorLevin(SBesselIntegrator):
    ...
    class Props:
        cheb_min_order: int
        cheb_reltol: float
        dead_edge_cells: bool
        ell_cache_max: int
        max_order: int
        n_knots: int
        reltol: float
        tau_constraint_guard: float
    ...
    def get_dead_edge_cells(self) -> bool: ...
    def get_ell_cache_max(self) -> int: ...
    def get_max_order(self) -> int: ...
    def get_n_constraint_fallbacks(self) -> int: ...
    def get_n_knots(self) -> int: ...
    def get_n_locked_eligible_solves(self) -> int: ...
    def get_n_panel_records(self) -> int: ...
    def get_n_panel_solves(self) -> int: ...
    def get_n_tau_solves(self) -> int: ...
    ...
    def get_reltol(self) -> float: ...
    def get_tau_constraint(self) -> bool: ...
    def get_tau_constraint_guard(self) -> float: ...
    ...
    def peek_ode_solver(self) -> SBesselOdeSolver: ...
    ...
    def set_dead_edge_cells(self, enable: bool) -> None: ...
    def set_max_order(self, max_order: int) -> None: ...
    def set_record_panels(self, record: bool) -> None: ...
    def set_reltol(self, reltol: float) -> None: ...
    def set_tau_constraint(self, tau_constraint: bool) -> None: ...
    def set_tau_constraint_guard(self, guard: float) -> None: ...
    def set_tau_constraint_min_osc(self, min_osc: float) -> None: ...
    def set_tau_constraint_order_fraction(self, fraction: float) -> None: ...
    def set_turning_knot_margin(self, margin: float) -> None: ...
...
class SBesselOdeOperator(GObject.GBoxed):
    @staticmethod
    def clear(op: SBesselOdeOperator) -> None: ...
    def get_constraint(self) -> SBesselOdeConstraint: ...
    def get_ell_range(self) -> typing.Tuple[int, int]: ...
    def get_interval(self) -> typing.Tuple[float, float]: ...
    def get_last_deriv_error(self, ell_idx: int) -> float: ...
    def get_last_max_coeff(self, ell_idx: int) -> float: ...
    def get_matrix(self, nrows: int) -> Matrix: ...
    def get_min_cols(self) -> int: ...
    def get_n_cols(self) -> int: ...
    def get_operator_size(self) -> int: ...
    def get_pins(self) -> typing.Tuple[int, int]: ...
    def get_tau_constraint_order(self, rhs_len: int) -> int: ...
    def get_tolerance(self) -> float: ...
    def ref(self) -> SBesselOdeOperator: ...
    def set_constraint(self, constraint: SBesselOdeConstraint) -> None: ...
    def set_min_cols(self, min_cols: int) -> None: ...
    def set_pinned_constraint(self, pin1: int, pin2: int) -> None: ...
    def solve(
...
class SBesselOdeSolver(GObject.Object):
    ...
    ::
        ...
        new() -> NumCosmoMath.SBesselOdeSolver
    ...
    def create_operator(
        self, a: float, b: float, ell_min: int, ell_max: int
    ) -> SBesselOdeOperator: ...
    def free(self) -> None: ...
    def get_default_constraint(self) -> SBesselOdeConstraint: ...
    def get_operator_matrix(
        self, a: float, b: float, ell: int, nrows: int
    ) -> Matrix: ...
    def get_operator_matrix_colmajor(
        self, a: float, b: float, ell: int, nrows: int
    ) -> Matrix: ...
    def get_tau_floor_factor(self) -> float: ...
    def get_tolerance(self) -> float: ...
    @classmethod
    def new(cls) -> SBesselOdeSolver: ...
    def peek_spectral(self) -> Spectral: ...
    def reconfigure_operator(
        self, op: SBesselOdeOperator, a: float, b: float, ell_min: int, ell_max: int
    ) -> None: ...
    def ref(self) -> SBesselOdeSolver: ...
    def set_default_constraint(self, constraint: SBesselOdeConstraint) -> None: ...
    def set_tau_floor_factor(self, factor: float) -> None: ...
    def set_tolerance(self, tol: float) -> None: ...
    def solve_dense(
        self, a: float, b: float, ell: int, rhs: Vector, nrows: int
    ) -> Vector: ...
...
class SFSBesselArray(GObject.Object):
    ...
    def eval1(self, ell: int, x: float) -> list[float]: ...
    ...
    def ref_table(
        self, x: typing.Sequence[float] | npt.NDArray[np.float64], ell_max: int
    ) -> Matrix: ...
...
class Serialize(GObject.Object):
    ...
    def dict_str_from_binfile(self, filename: str) -> ObjDictStr: ...
    ...
    def dict_str_to_binfile(self, ods: ObjDictStr, filename: str) -> None: ...
...
class SkyFootprint(GObject.Object):
    r"""
    :Constructors:

    ::

        SkyFootprint(**properties)

    Object NcmSkyFootprint
    ...
    parent_instance: GObject.Object = ...
    @staticmethod
    def clear(footprint: SkyFootprint) -> None: ...
    def contains(self, ra: float, dec: float) -> bool: ...
    def density(self, ra: float, dec: float) -> float: ...
    def do_contains(self, ra: float, dec: float) -> bool: ...
    def do_density(self, ra: float, dec: float) -> float: ...
    def do_gen_ra_dec(self, rng: RNG) -> typing.Tuple[float, float]: ...
    def do_get_area(self) -> float: ...
    def do_ln_density(self, ra: float, dec: float) -> float: ...
    def free(self) -> None: ...
    def gen_ra_dec(self, rng: RNG) -> typing.Tuple[float, float]: ...
    def get_area(self) -> float: ...
    def ln_density(self, ra: float, dec: float) -> float: ...
    def ref(self) -> SkyFootprint: ...

class SkyFootprintClass(GObject.GPointer):
    r"""
    :Constructors:
    ...
    parent_class: GObject.ObjectClass = ...
    gen_ra_dec: typing.Callable[[SkyFootprint, RNG], typing.Tuple[float, float]] = ...
    contains: typing.Callable[[SkyFootprint, float, float], bool] = ...
    get_area: typing.Callable[[SkyFootprint], float] = ...
    density: typing.Callable[[SkyFootprint, float, float], float] = ...
    ln_density: typing.Callable[[SkyFootprint, float, float], float] = ...
    padding: list[None] = ...

class SkyFootprintRectangular(SkyFootprint):
    r"""
    :Constructors:

    ::

        SkyFootprintRectangular(**properties)
        new(ra_min:float, ra_max:float, dec_min:float, dec_max:float) -> NumCosmoMath.SkyFootprintRectangular

    Object NcmSkyFootprintRectangular

    Properties from NcmSkyFootprintRectangular:
      ra-lim -> NcmDTuple2: RA limits
        Right ascension limits (min, max) in degrees
      dec-lim -> NcmDTuple2: DEC limits
    ...
    props: Props = ...
    def __init__(self, dec_lim: DTuple2 = ..., ra_lim: DTuple2 = ...) -> None: ...
    @staticmethod
    def clear(rect: SkyFootprintRectangular) -> None: ...
    def free(self) -> None: ...
    ...
    def ref(self) -> SkyFootprintRectangular: ...
    def set_dec_lim(self, dec_min: float, dec_max: float) -> None: ...
    def set_ra_lim(self, ra_min: float, ra_max: float) -> None: ...

class SkyFootprintRectangularClass(GObject.GPointer):
    r"""
    :Constructors:

    ::

        SkyFootprintRectangularClass()
    """

    parent_class: SkyFootprintClass = ...
...
class Spectral(GObject.Object):
    ...
    @staticmethod
    def chebT_to_gegenbauer_alpha2(
        c: typing.Sequence[float] | npt.NDArray[np.float64],
    ) -> list[float]: ...
    @staticmethod
    def chebyshev_deriv(
    ...
    def compute_chebyshev_coeffs_adaptive_full(
        self,
        F: typing.Callable[..., float],
        a: float,
        b: float,
    ...
    def compute_chebyshev_coeffs_adaptive_try(
        self,
        F: typing.Callable[..., float],
        a: float,
        b: float,
    ...
    @staticmethod
    def compute_d_row(row_data: float, offset: int, coeff: float) -> None: ...
    @staticmethod
    def compute_proj_row(
...
class SphereMap(GObject.Object):
    ...
    def compute_cross_Cl(self, smap2: SphereMap) -> Vector: ...
    def free(self) -> None: ...
...
class Spline(GObject.Object):
    ...
    def curvature_density(self, ctype: SplineCurvatureType, x: float) -> float: ...
    def curvature_lp_norm(
        self, ctype: SplineCurvatureType, p: float, xi: float, xf: float
    ) -> float: ...
    def curvature_max(
        self, ctype: SplineCurvatureType, xi: float, xf: float
    ) -> float: ...
    def curvature_weighted_lp_norm(
        self, ctype: SplineCurvatureType, p: float, weight: Spline, xi: float, xf: float
    ) -> float: ...
    def do_copy_empty(self) -> Spline: ...
    def do_deriv(self, x: float) -> float: ...
    def do_deriv2(self, x: float) -> float: ...
    def do_deriv_idx(self, x: float, i: int) -> float: ...
    def do_deriv_nmax(self, x: float) -> float: ...
    def do_eval(self, x: float) -> float: ...
    def do_eval_idx(self, x: float, i: int) -> float: ...
    def do_integ(self, xi: float, xf: float) -> float: ...
    def do_integ_idx(self, xi: float, i: int, xf: float, f: int) -> float: ...
    ...
    def eval_deriv_idx(self, x: float, i: int) -> float: ...
    def eval_deriv_nmax(self, x: float) -> float: ...
    def eval_idx(self, x: float, i: int) -> float: ...
    def eval_integ(self, x0: float, x1: float) -> float: ...
    def eval_integ_idx(self, xi: float, i: int, xf: float, f: int) -> float: ...
    def free(self) -> None: ...
...
class SplineClass(GObject.GPointer):
    ...
    eval_idx: typing.Callable[[Spline, float, int], float] = ...
    deriv_idx: typing.Callable[[Spline, float, int], float] = ...
    integ_idx: typing.Callable[[Spline, float, int, float, int], float] = ...
    padding: list[None] = ...
...
class SplineVec(GObject.Object):
    r"""
    :Constructors:

    ::

        SplineVec(**properties)
        new(s:NumCosmoMath.Spline, xv:NumCosmoMath.Vector, ym:NumCosmoMath.Matrix, init:bool) -> NumCosmoMath.SplineVec
        new_gpa(s:NumCosmoMath.Spline, xv:NumCosmoMath.Vector, yv:list, init:bool) -> NumCosmoMath.SplineVec

    Object NcmSplineVec

    Properties from NcmSplineVec:
      spline -> NcmSpline: spline
        Base spline
      len -> guint: len
    ...
    @staticmethod
    def clear(sv: SplineVec) -> None: ...
    def deriv(self, x: float, res: Vector) -> None: ...
    def deriv_array(self, x: float) -> list[float]: ...
    def eval(self, x: float, res: Vector) -> None: ...
    def eval_array(self, x: float) -> list[float]: ...
    def free(self) -> None: ...
    def get_len(self) -> int: ...
    def get_nknots(self) -> int: ...
    def integ(self, xi: float, xf: float, res: Vector) -> None: ...
    def integ_array(self, xi: float, xf: float) -> list[float]: ...
    def is_init(self) -> bool: ...
    @classmethod
    def new(cls, s: Spline, xv: Vector, ym: Matrix, init: bool) -> SplineVec: ...
    @classmethod
    def new_gpa(
        cls, s: Spline, xv: Vector, yv: typing.Sequence[Vector], init: bool
    ) -> SplineVec: ...
    def peek_spline(self, i: int) -> Spline: ...
    def prepare(self) -> None: ...
    def ref(self) -> SplineVec: ...
    def set(self, xv: Vector, ym: Matrix, init: bool) -> None: ...
    def set_gpa(self, xv: Vector, yv: typing.Sequence[Vector], init: bool) -> None: ...

class SplineVecClass(GObject.GPointer):
    r"""
    :Constructors:
...
class StatsAcorr(GObject.Object):
    r"""
    :Constructors:

    ::

        StatsAcorr(**properties)
        new(len:int) -> NumCosmoMath.StatsAcorr
        new_full(len:int, max_lag:int, max_levels:int, method:NumCosmoMath.StatsAcorrMethod) -> NumCosmoMath.StatsAcorr

    Object NcmStatsAcorr

    Properties from NcmStatsAcorr:
      len -> guint: len
        Number of series
      max-lag -> guint: max-lag
        Number of lags per level
      max-levels -> guint: max-levels
        Maximum number of block-averaging levels
      method -> NcmStatsAcorrMethod: method
        Estimator
      ar-criterion -> NcmStatsAcorrARCrit: ar-criterion
        Auto-regressive order criterion
      reliability-factor -> gdouble: reliability-factor
        Required number of autocorrelation times
      drift-threshold -> gdouble: drift-threshold
    ...
    class Props:
        ar_criterion: StatsAcorrARCrit
        drift_threshold: float
        len: int
        max_lag: int
        max_levels: int
        method: StatsAcorrMethod
    ...
    @staticmethod
    def acov_fft(series: Vector, max_lag: int) -> Vector: ...
    @staticmethod
    def ar_fit(
        acov: Vector, nitens: int, crit: StatsAcorrARCrit
    ) -> typing.Tuple[bool, Vector, Vector, float, int]: ...
    @staticmethod
    def clear(acorr: StatsAcorr) -> None: ...
    def free(self) -> None: ...
    def get_acf(self, p: int, level: int) -> Vector: ...
    def get_acov(self, p: int, level: int) -> Vector: ...
    def get_ar_criterion(self) -> StatsAcorrARCrit: ...
    def get_ar_fit(self, p: int) -> typing.Tuple[bool, Vector, Vector, float, int]: ...
    def get_ar_order(self, p: int) -> int: ...
    def get_diag(self, p: int) -> StatsAcorrDiag: ...
    def get_drift_threshold(self) -> float: ...
    def get_drift_z(self, p: int) -> float: ...
    def get_ess(self, p: int) -> float: ...
    def get_level(self, p: int) -> int: ...
    def get_max_lag(self) -> int: ...
    def get_max_levels(self) -> int: ...
    def get_mean(self, p: int) -> float: ...
    def get_method(self) -> StatsAcorrMethod: ...
    def get_reliability_factor(self) -> float: ...
    def get_sd_mean(self, p: int) -> float: ...
    def get_spec0(self, p: int) -> float: ...
    def get_tau(self, p: int) -> float: ...
    def get_tau_method(self, p: int, method: StatsAcorrMethod) -> float: ...
    def get_var(self, p: int) -> float: ...
    def get_var_mean(self, p: int) -> float: ...
    def get_var_ratio(self, p: int) -> float: ...
    def get_window(self, p: int) -> int: ...
    def len(self) -> int: ...
    def level_nitens(self, p: int, level: int) -> int: ...
    @classmethod
    def new(cls, len: int) -> StatsAcorr: ...
    @classmethod
    def new_full(
        cls, len: int, max_lag: int, max_levels: int, method: StatsAcorrMethod
    ) -> StatsAcorr: ...
    def nitens(self, p: int) -> int: ...
    def nlevels(self, p: int) -> int: ...
    def ref(self) -> StatsAcorr: ...
    def reset(self) -> None: ...
    def set_ar_criterion(self, crit: StatsAcorrARCrit) -> None: ...
    def set_drift_threshold(self, threshold: float) -> None: ...
    def set_method(self, method: StatsAcorrMethod) -> None: ...
    def set_reliability_factor(self, factor: float) -> None: ...
    def set_series(self, p: int, series: Vector) -> None: ...
    def set_series_matrix(self, series: Matrix) -> None: ...
    @staticmethod
    def tau_ar(
        acov: Vector, nitens: int, crit: StatsAcorrARCrit
    ) -> typing.Tuple[float, int]: ...
    @staticmethod
    def tau_geyer(acov: Vector) -> typing.Tuple[float, int]: ...
    @staticmethod
    def tau_sokal(acov: Vector, c: float) -> typing.Tuple[float, int]: ...
    def update(self, x: Vector) -> None: ...
    def update_var(self, p: int, x_p: float) -> None: ...

class StatsAcorrClass(GObject.GPointer):
    r"""
    :Constructors:
...
class StatsDist(GObject.Object):
    ...
    def do_amise(self) -> float: ...
    def do_bandwidth(self) -> float: ...
    ...
    def do_prepare_kernels(self) -> None: ...
    def do_prepare_shapes(self, sample_array: typing.Sequence[Vector]) -> None: ...
    def do_reset(self) -> None: ...
    def do_set_dim(self, dim: int) -> None: ...
    def eval(self, x: Vector) -> float: ...
    def eval_m2lnp(self, x: Vector) -> float: ...
    def eval_m2lnp_vec(self, x_a: typing.Sequence[Vector], m2lnp: Vector) -> None: ...
    def free(self) -> None: ...
    ...
    def prepare(self, m2lnL: typing.Optional[Vector] = None) -> None: ...
    def prepare_shapes(self, sample_array: typing.Sequence[Vector]) -> None: ...
...
class StatsDistClass(GObject.GPointer):
    ...
    bandwidth: typing.Callable[[StatsDist], float] = ...
    prepare_shapes: typing.Callable[[StatsDist, typing.Sequence[Vector]], None] = ...
    prepare_kernels: typing.Callable[[StatsDist], None] = ...
    compute_IM: typing.Callable[[StatsDist, Matrix], None] = ...
    amise: typing.Callable[[StatsDist], float] = ...
    ...
    eval_weights_m2lnp_vec: None = ...
    eval_weights_m2lnp_loo: None = ...
...
class StatsDistKernel(GObject.Object):
    ...
    def do_eval_gamma_lambda(
        self, chi2: Vector, lnc: Vector, lnK: Vector
    ) -> typing.Tuple[float, float]: ...
...
class StatsDistKernelClass(GObject.GPointer):
    ...
    get_var_factor: typing.Callable[[StatsDistKernel], float] = ...
    ...
    eval_gamma_lambda: typing.Callable[
        [StatsDistKernel, Vector, Vector, Vector], typing.Tuple[float, float]
    ] = ...
...
class VarDict(GObject.GBoxed):
    ...
    def get_object(
        self, key: str, ser: Serialize
    ) -> typing.Tuple[bool, GObject.Object]: ...
    def get_object_array(
        self, key: str, ser: Serialize
    ) -> typing.Tuple[bool, ObjArray]: ...
    ...
    def set_object(self, key: str, ser: Serialize, obj: GObject.Object) -> None: ...
    def set_object_array(self, key: str, ser: Serialize, oa: ObjArray) -> None: ...
...
class Vector(GObject.Object):
    ...
    def set_from_variant(self, var: GLib.Variant) -> None: ...
    def set_zero(self) -> None: ...
    def sqr_dist(self, cv2: Vector) -> float: ...
    def sqrt(self) -> None: ...
...
class StatsAcorrDiag(GObject.GFlags):
    DRIFT: StatsAcorrDiag = ...
    METHOD_DISAGREEMENT: StatsAcorrDiag = ...
    OK: StatsAcorrDiag = ...
    SHORT_CHAIN: StatsAcorrDiag = ...
    VARIANCE_SHIFT: StatsAcorrDiag = ...
    WINDOW_TRUNCATED: StatsAcorrDiag = ...
    ZERO_VARIANCE: StatsAcorrDiag = ...
    _all_bits_: int = ...
    _boundary_: FlagBoundary = ...
    _flag_mask_: int = ...
    _generate_next_value_: function = ...
    ...
    _value_repr_: wrapper_descriptor = ...
    @staticmethod
    def to_string(diag: StatsAcorrDiag) -> str: ...
...
class CatalogColType(GObject.GEnum):
    BOOL: CatalogColType = ...
    DOUBLE: CatalogColType = ...
    INT: CatalogColType = ...
    INVALID: CatalogColType = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class ModelError(GObject.GEnum):
    ...
    PARAM_NAME_AMBIGUOUS: ModelError = ...
...
class SBesselOdeConstraint(GObject.GEnum):
    DIRICHLET: SBesselOdeConstraint = ...
    PINNED: SBesselOdeConstraint = ...
    TAU: SBesselOdeConstraint = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class SplineCurvatureType(GObject.GEnum):
    D2: SplineCurvatureType = ...
    GEOMETRIC: SplineCurvatureType = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class StatsAcorrARCrit(GObject.GEnum):
    AIC: StatsAcorrARCrit = ...
    AICC: StatsAcorrARCrit = ...
    FPE: StatsAcorrARCrit = ...
    NONE: StatsAcorrARCrit = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...
...
class StatsAcorrMethod(GObject.GEnum):
    AR: StatsAcorrMethod = ...
    GEYER: StatsAcorrMethod = ...
    MAX: StatsAcorrMethod = ...
    SOKAL: StatsAcorrMethod = ...
    _generate_next_value_: function = ...
    _hashable_values_: list = ...
    _member_map_: dict = ...
    _member_names_: list = ...

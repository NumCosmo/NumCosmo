...
class CSQ1D(GObject.Object):
    ...
    def do_eval_dm(self, model: Optional[Model], t: float) -> float: ...
    ...
    def eval_dm(self, model: Optional[Model], t: float) -> float: ...
...
class CSQ1DClass(GObject.GPointer):
    ...
    eval_powspec_factor: Callable[[CSQ1D, Optional[Model]], float] = ...

...
# | fig-cap: "Scaling of the power spectrum normalization $P_{k_0}$ with the equation-of-state parameter $w$. The comparison with the expected $w^{-5/2}$ power law shows excellent agreement."
# | fig-cap-location: bottom
# | code-fold: true
...
ax.set_yscale("log")
ax.set_xlabel(r"$w$")
ax.set_ylabel(r"$P_{k_0}(w)$")
ax.set_title(r"Normalization $P_{k_0}$ at $k = k_{\rm min}$")
ax.legend(loc="best")

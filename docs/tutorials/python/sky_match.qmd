...
cluster_r = np.array(dist.comoving_vector(cosmo, cluster_z)) * cosmo.RH_Mpc()
cluster_x1 = (
...
# | fig-cap: The generated clusters and halos in the sky.
# | fig-cap-location: margin
# | fig-width: 100%
# | code-fold: true
...
```{python}
# | label: tbl-clusters
# | fig-cap: The generated clusters in the sky.
# | fig-cap-location: margin
# | fig-width: 100%
# | code-fold: true
...
# | fig-cap: The result of the 3D matching.
# | fig-cap-location: margin
# | fig-width: 100%
# | code-fold: true
...
# | fig-cap: The filtered result of the 3D matching.
# | fig-cap-location: margin
# | fig-width: 100%
# | code-fold: true
...
# | fig-cap: The best matched clusters
# | fig-cap-location: margin
# | fig-width: 100%
# | code-fold: true
...
# | fig-cap: The distances between clusters and halos computed using the cluster redshifts.
# | fig-cap-location: margin
# | fig-width: 100%
# | code-fold: true
...
# | fig-cap: Filtered distances between clusters and halos computed using cluster redshifts.
# | fig-cap-location: margin
# | fig-width: 100%
# | code-fold: true
...
# | fig-cap: Match statistics between clusters and halos computed using cluster redshifts.
# | fig-cap-location: margin
# | fig-width: 100%
# | code-fold: true
...
In summary, we have successfully matched the clusters with the halos, noting that our artificially produced dataset was not perfect, and there are some incorrect matches.

...
Compares power spectra and derived quantities from CCL and NumCosmo.
Reports the relative differences of the matter power spectrum, growth factor, and `sigma_8`.
The comparison uses matched cosmological parameters and reports relative
differences in tables and plots.

...
Computes and compares linear and nonlinear matter power spectra using the
Eisenstein-Hu transfer function and CLASS backend.
...
([[numcosmo|NcHICosmoDEXcdm]]) and setting its parameters. We also include a reionization model and
...
# Create a new cosmological model with one massive neutrino, attaching the
# reionization and primordial submodels at construction time
...
Computes and compares linear and nonlinear matter power spectra with the
Eisenstein-Hu transfer function and CLASS backend.

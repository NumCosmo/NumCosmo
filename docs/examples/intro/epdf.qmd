...
date: "2023-05-19"
abstract: |
  Computes a PDF and CDF from samples using `Ncm.StatsDist1dEPDF`.
...
Builds a Gaussian-mixture sample, reconstructs its PDF and CDF, and compares
the result with the analytic distribution.
...
Reconstruct the PDF and CDF with `Ncm.StatsDist1dEPDF`, using automatic
(`AUTO`) and rule-of-thumb (`ROT`) bandwidths.
...
Plot the reconstructed PDF, CDF, and inverse CDF against the true distribution.
...
# | fig-cap: >
# |   The reconstructed probability density function (PDF) compared with the true
# |   distribution.
# | fig-width: 100%
...
# | fig-cap: >
# |   The relative difference between the reconstructed PDF and the true distribution.
# | fig-width: 100%
# | fig-cap-location: margin
# | code-fold: true
...
# | fig-cap: >
# |   The reconstructed cumulative distribution function (CDF) compared with the true
# |   distribution.
# | fig-width: 100%
# | fig-cap-location: margin
# | code-fold: true
...
# | fig-cap: >
# |   The relative difference between the reconstructed CDF and the true distribution.
# | fig-width: 100%
# | fig-cap-location: margin
# | code-fold: true
...
`Ncm.StatsDist1dEPDF` reconstructs the PDF and CDF of sampled points.

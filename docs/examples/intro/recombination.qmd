...
Computes ionization history, equilibrium fractions, and visibility functions
with the `numcosmo` library.
...
# | fig-cap: >
# |   Ionization history. The plot shows the evolution of the ionization fractions with
# |   the scale factor.
# | fig-width: 100%
...
# | fig-cap: >
# |   Equilibrium fraction of ionized hydrogen and helium as a function of the scale
# |   factor.
# | fig-width: 100%
# | fig-cap-location: margin
# | code-fold: true

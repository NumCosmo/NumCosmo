...
date: "2026-05-14"
abstract: |
  Compares [[numcosmo|NcHICosmoDEWSpline]] with a constant-$w$ cosmology.
...
Compare two cosmologies with the same background parameters:

1. [[numcosmo|NcHICosmoDEXcdm]] with constant $w = -1$.
2. [[numcosmo|NcHICosmoDEWSpline]] with a knot-based $w(z)$ history.

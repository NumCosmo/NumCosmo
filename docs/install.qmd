...
To streamline the installation process of NumCosmo, conda-forge offers a convenient option. You can install NumCosmo either by explicitly setting the conda-forge channel or by utilizing a conda-forge-only environment, available for download [here](https://github.com/conda-forge/miniforge).
...
Conda streamlines the installation process for NumCosmo Library on Linux and Mac OS. 
...
Execute the following commands in the root directory of the NumCosmo repository:

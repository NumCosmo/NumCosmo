...
params_ids = ['clusterid', 'Fit_H0', 'Prior_H0', 'H0', 'plane', 'Omega_k', 'Fit_Omega_c', 'Omega_c', 'Fit_Omega_x', 'Omega_x',
              ...
              'Fit_w1', 'eqos_w1', 'multiplicity', 'mf_ds_index', 'area', 'z_initial', 'z_final', 'Mi', 'Mf', 'photoz', 'photoz_sigma', 
              'Mobs', 'Mobs_sigma', 'estimator', 'zbin', 'statist_method', 'cr_x_axis', 'cr_y_axis', 'darkenergy', 'massf_print', 
              'fiducial_available']
...
def plot_mass_function (run_params, outFile3):
    ...
    print 'Chegou no plot mass function'
    list_plots = {}
    list_plots['massfunc'] = []

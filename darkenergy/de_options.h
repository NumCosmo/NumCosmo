...
#define NC_DE_FIT_ENTRIES { NULL, FALSE, "nlopt",   "numdiff-forward", NULL, 1e-8, 1e-5, -1, -1, {-1, -1}, NULL, NCM_FIT_DEFAULT_MAXITER, FALSE, NCM_FIT_RUN_MSGS_SIMPLE, -1, -1, NCM_FIT_MC_RESAMPLE_FROM_MODEL, 0, 0, -1, 1.0e3, NULL, NULL, FALSE, FALSE, FALSE, 1.0, 100, FALSE, 1.0, FALSE, FALSE, NULL}
#else
#define NC_DE_FIT_ENTRIES { NULL, FALSE, "gsl-mms", "numdiff-forward", NULL, 1e-8, 1e-5, -1, -1, {-1, -1}, NULL, NCM_FIT_DEFAULT_MAXITER, FALSE, NCM_FIT_RUN_MSGS_SIMPLE, -1, -1, NCM_FIT_MC_RESAMPLE_FROM_MODEL, 0, 0, -1, 1.0e3, NULL, NULL, FALSE, FALSE, FALSE, 1.0, 100, FALSE, 1.0, FALSE, FALSE, NULL}
#endif

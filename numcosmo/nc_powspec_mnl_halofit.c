...
nc_powspec_mnl_halofit_class_init (NcPowspecMNLHaloFitClass *klass)
{
  ...
  /**
   * NcPowspecMNLHaloFit:power-spec:
   *
  ...
  /**
   * NcPowspecMNLHaloFit:use-pkequal:
   *
...
static gdouble
_nc_powspec_mnl_halofit_Pklin2Pknln (NcPowspecMNLHaloFit *pshf, NcHICosmo *cosmo, const gdouble k, const gdouble Pklin)
{
  NcPowspecMNLHaloFitPrivate * const self = pshf->priv;
 ...
 * @psml: a #NcPowspecML
 * @zmaxnl: maximum redshift for the halofit correction
 * @reltol: relative tolerance (precision) for halofit computations
 *

...
G_DEFINE_TYPE (NcHICosmoGCG, nc_hicosmo_gcg, NC_TYPE_HICOSMO);
...
nc_hicosmo_gcg_init (NcHICosmoGCG *cosmo_de)
{
  ...
  cosmo_de->priv               = G_TYPE_INSTANCE_GET_PRIVATE (cosmo_de, NC_TYPE_HICOSMO_GCG, NcHICosmoGCGPrivate);
...
nc_hicosmo_gcg_class_init (NcHICosmoGCGClass *klass)
{
  ...
  g_type_class_add_private (klass, sizeof (NcHICosmoGCGPrivate));

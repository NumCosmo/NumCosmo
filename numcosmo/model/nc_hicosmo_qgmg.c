 ...
 * \end{align}
 * where
 * $$R \equiv \frac{\Omega_{r0} x}{\Omega_{w0} x^{3w}}.$$
 *
 */
...
static void
nc_hicosmo_qgmg_finalize (GObject *object)
{
  /* Chain up : end */
  G_OBJECT_CLASS (nc_hicosmo_qgmg_parent_class)->finalize (object);
}

static gdouble _nc_hicosmo_qgmg_E2 (NcHICosmo *cosmo, gdouble z);
static gdouble _nc_hicosmo_qgmg_dE2_dz (NcHICosmo *cosmo, gdouble z);
static gdouble _nc_hicosmo_qgmg_E2 (NcHICosmo *cosmo, gdouble z);
static gdouble _nc_hicosmo_qgmg_d2E2_dz2 (NcHICosmo *cosmo, gdouble z);
static gdouble _nc_hicosmo_qgmg_bgp_cs2 (NcHICosmo *cosmo, gdouble z);

static gdouble _nc_hicosmo_qgmg_H0 (NcHICosmo *cosmo);
static gdouble _nc_hicosmo_qgmg_Omega_t0 (NcHICosmo *cosmo);
...
nc_hicosmo_qgmg_class_init (NcHICosmoQGMGClass *klass)
{
  ...
  ncm_model_class_set_name_nick (model_class, "QGMG", "QGMG");
  ncm_model_class_add_params (model_class, NC_HICOSMO_QGMG_SPARAM_LEN, 0, PROP_SIZE);

  /* Set H_0 param info */
  ncm_model_class_set_sparam (model_class, NC_HICOSMO_QGMG_H0, "H_0", "H0",
                              10.0, 500.0, 1.0,
  ...
  ncm_model_class_set_sparam (model_class, NC_HICOSMO_QGMG_X_B, "x_b", "xb",
                              ...
                              NC_HICOSMO_DEFAULT_PARAMS_ABSTOL, NC_HICOSMO_QGMG_DEFAULT_X_B,
                              NCM_PARAM_TYPE_FIXED);

  /* Check for errors in parameters initialization */
  ncm_model_class_check_params_info (model_class);

  nc_hicosmo_set_H0_impl        (parent_class, &_nc_hicosmo_qgmg_H0);
  nc_hicosmo_set_E2_impl        (parent_class, &_nc_hicosmo_qgmg_E2);
  nc_hicosmo_set_Omega_c0_impl  (parent_class, &_nc_hicosmo_qgmg_Omega_c0);
  nc_hicosmo_set_Omega_t0_impl  (parent_class, &_nc_hicosmo_qgmg_Omega_t0);
  nc_hicosmo_set_xb_impl        (parent_class, &_nc_hicosmo_qgmg_xb);
  nc_hicosmo_set_dE2_dz_impl    (parent_class, &_nc_hicosmo_qgmg_dE2_dz);
  nc_hicosmo_set_d2E2_dz2_impl  (parent_class, &_nc_hicosmo_qgmg_d2E2_dz2);
...
static gdouble _nc_hicosmo_qgmg_gw_eval_F1 (NcHIPertIGW *igw, const gdouble alpha, const gdouble k);
static gdouble _nc_hicosmo_qgmg_gw_eval_nu (NcHIPertIGW *igw, const gdouble alpha, const gdouble k);
static gdouble _nc_hicosmo_qgmg_gw_eval_m (NcHIPertIGW *igw, const gdouble alpha, const gdouble k);
static gdouble _nc_hicosmo_qgmg_gw_eval_unit (NcHIPertIGW *igw);
static gdouble _nc_hicosmo_qgmg_gw_eval_x (NcHIPertIGW *igw, const gdouble alpha);

static void
nc_hipert_igw_interface_init (NcHIPertIGWInterface *iface)
{
  iface->eval_xi   = &_nc_hicosmo_qgmg_gw_eval_xi;
  iface->eval_F1   = &_nc_hicosmo_qgmg_gw_eval_F1;
  iface->eval_nu   = &_nc_hicosmo_qgmg_gw_eval_nu;
  iface->eval_m    = &_nc_hicosmo_qgmg_gw_eval_m;
  iface->eval_unit = &_nc_hicosmo_qgmg_gw_eval_unit;
  iface->eval_x    = &_nc_hicosmo_qgmg_gw_eval_x;
}

static gdouble _nc_hicosmo_qgmg_adiab_eval_xi (NcHIPertIAdiab *iad, const gdouble alpha, const gdouble k);
static gdouble _nc_hicosmo_qgmg_adiab_eval_F1 (NcHIPertIAdiab *iad, const gdouble alpha, const gdouble k);
static gdouble _nc_hicosmo_qgmg_adiab_eval_nu (NcHIPertIAdiab *iad, const gdouble alpha, const gdouble k);
static gdouble _nc_hicosmo_qgmg_adiab_eval_m (NcHIPertIAdiab *iad, const gdouble alpha, const gdouble k);
static gdouble _nc_hicosmo_qgmg_adiab_eval_unit (NcHIPertIAdiab *iad);
static gdouble _nc_hicosmo_qgmg_adiab_eval_x (NcHIPertIAdiab *iad, const gdouble alpha);
static gdouble _nc_hicosmo_qgmg_adiab_eval_p2Psi (NcHIPertIAdiab *iad, const gdouble alpha, const gdouble k);
static gdouble _nc_hicosmo_qgmg_adiab_eval_p2drho (NcHIPertIAdiab *iad, const gdouble alpha, const gdouble k);
static gdouble _nc_hicosmo_qgmg_adiab_eval_lapse (NcHIPertIAdiab *iad, const gdouble alpha);

static void
nc_hipert_iadiab_interface_init (NcHIPertIAdiabInterface *iface)
{
  iface->eval_xi         = &_nc_hicosmo_qgmg_adiab_eval_xi;
  iface->eval_F1         = &_nc_hicosmo_qgmg_adiab_eval_F1;
  iface->eval_nu         = &_nc_hicosmo_qgmg_adiab_eval_nu;
  iface->eval_m          = &_nc_hicosmo_qgmg_adiab_eval_m;
  iface->eval_unit       = &_nc_hicosmo_qgmg_adiab_eval_unit;
  iface->eval_x          = &_nc_hicosmo_qgmg_adiab_eval_x;
  iface->eval_p2Psi      = &_nc_hicosmo_qgmg_adiab_eval_p2Psi;
  iface->eval_p2drho     = &_nc_hicosmo_qgmg_adiab_eval_p2drho;
  iface->eval_lapse      = &_nc_hicosmo_qgmg_adiab_eval_lapse;
...
static gdouble
_nc_hicosmo_qgmg_dE2_dz (NcHICosmo *cosmo, gdouble z)
{
  const gdouble x    = 1.0 + z;
  const gdouble x2   = x * x;
  const gdouble x3   = x2 * x;
...
static gdouble
_nc_hicosmo_qgmg_d2E2_dz2 (NcHICosmo *cosmo, gdouble z)
{
  const gdouble x           = 1.0 + z;
  const gdouble x2          = x * x;
  const gdouble x3          = x2 * x;
 ...
 ****************************************************************************/
static gdouble
_nc_hicosmo_qgmg_bgp_cs2 (NcHICosmo *cosmo, gdouble z)
{
  const gdouble x   = 1.0 + z;
  const gdouble x2  = x * x;
  const gdouble x3  = x2 * x;
 ...
 ****************************************************************************/
static gdouble
_nc_hicosmo_qgmg_H0 (NcHICosmo *cosmo)
{
  return MACRO_H0 * (OMEGA_R + OMEGA_W);
}

static gdouble
_nc_hicosmo_qgmg_Omega_t0 (NcHICosmo *cosmo)
{
  return 1.0;
}

static gdouble
_nc_hicosmo_qgmg_Omega_c0 (NcHICosmo *cosmo)
{
  return OMEGA_W;
}

static gdouble
_nc_hicosmo_qgmg_xb (NcHICosmo *cosmo)
{
  return X_B;
}
...
#define _NC_HICOSMO_QGMG_WKB_COMMON1                                               \
...
#define _NC_HICOSMO_QGMG_WKB_COMMON2                                                                          \
...
#define _NC_HICOSMO_QGMG_WKB_COMMON22 \
        const gdouble d2R = onem3w * d1R;

#define _NC_HICOSMO_QGMG_WKB_COMMON222                                                                                                                     \
...
#define _NC_HICOSMO_QGMG_WKB_NUB2 \
        const gdouble nuB2 = nuS2 - VS;

#define _NC_HICOSMO_QGMG_WKB_P6 \
        const gdouble p6 = sqrt (x3 / (x3w * Omegaw)) / (3.0 * onepw * onepw2 * R);

#define _NC_HICOSMO_QGMG_WKB_MS  \
        _NC_HICOSMO_QGMG_WKB_P6; \
        const gdouble mS = sqrt (p2) * p4 * p4 * p6 / p3;

#define _NC_HICOSMO_QGMG_ONE_M_Y2 \
        const gdouble one_m_y2 = w * w2 * gsl_pow_2 (onepw + onepw2 * R) / (p1 * p3);

#define _NC_HICOSMO_QGMG_ODE_FULL_DIFF                                                                        \
...
_nc_hipert_itwo_fluids_eom (NcHIPertITwoFluids *itf, gdouble alpha, gdouble k)
{
  ...
  NcHICosmoQGMG *qgmg = NC_HICOSMO_QGMG (itf);

  if ((qgmg->eom_two_fluids.skey  != ncm_model_state_get_pkey (NCM_MODEL (itf))) ||
      (qgmg->eom_two_fluids.alpha != alpha) ||
      (qgmg->eom_two_fluids.k     != k))
  {
    ...
    qgmg->eom_two_fluids.nu1 = c1 * Fnu;
    qgmg->eom_two_fluids.nu2 = c2 * Fnu;

    qgmg->eom_two_fluids.gammabar11 =
      (
    ...
    qgmg->eom_two_fluids.gammabar22 =
      (
        +1.0 * (9.0 * c24 - 1.0) / 4.0
    ...
    qgmg->eom_two_fluids.gammabar12 =
      (
    ...
    qgmg->eom_two_fluids.taubar = sin_2phi * (c2 - c1) * d1lnE / (sc1 * sc2);

    {
      ...
      qgmg->eom_two_fluids.cos2phi   = cos2_phi;
      qgmg->eom_two_fluids.sin2phi   = sin2_phi;
      qgmg->eom_two_fluids.cs2       = c1 * c1 * cos2_phi + c2 * c2 * sin2_phi;
      qgmg->eom_two_fluids.cm2       = c2 * c2 * cos2_phi + c1 * c1 * sin2_phi;
      qgmg->eom_two_fluids.m_zeta    = rhopp / (cs2 * absE * x3);
      qgmg->eom_two_fluids.m_s       = absE * x3 / (cm2 * rhopp * cos2_phi * sin2_phi);
      qgmg->eom_two_fluids.mnu2_zeta = rhopp * k * k / (x * gsl_pow_3 (absE));
      qgmg->eom_two_fluids.mnu2_s    = x3 * x2 * k * k / (absE * rhopp * cos2_phi * sin2_phi);
      qgmg->eom_two_fluids.y         = epsilon * (c1 * c1 - c2 * c2) * cos2_phi * sin2_phi;

      qgmg->eom_two_fluids.gw1 = gw1;
      qgmg->eom_two_fluids.gw2 = gw2;
      qgmg->eom_two_fluids.Fnu = Fnu;
    }

    qgmg->eom_two_fluids.skey  = ncm_model_state_get_pkey (NCM_MODEL (cosmo));
    qgmg->eom_two_fluids.alpha = alpha;
    qgmg->eom_two_fluids.k     = k;
  }

  return &qgmg->eom_two_fluids;
}
...
_nc_hipert_itwo_fluids_wkb (NcHIPertITwoFluids *itf, gdouble alpha, gdouble k)
{
  ...
  qgmg->wkb_two_fluids.state.alpha = alpha;
  qgmg->wkb_two_fluids.state.k     = k;
  qgmg->wkb_two_fluids.state.gw1   = gw1;
  qgmg->wkb_two_fluids.state.gw2   = gw2;
  qgmg->wkb_two_fluids.state.Fnu   = Fnu;
  qgmg->wkb_two_fluids.state.norma = _nc_hipert_itwo_fluids_eval_unit (itf);

  qgmg->wkb_two_fluids.state.zeta1  = vzeta1;
  qgmg->wkb_two_fluids.state.Q1     = vQ1;
  qgmg->wkb_two_fluids.state.Pzeta1 = vPzeta1;
  qgmg->wkb_two_fluids.state.PQ1    = vPQ1;

  qgmg->wkb_two_fluids.state.zeta2  = vzeta2;
  qgmg->wkb_two_fluids.state.Q2     = vQ2;
  qgmg->wkb_two_fluids.state.Pzeta2 = vPzeta2;
  qgmg->wkb_two_fluids.state.PQ2    = vPQ2;
 ...
 */
  ...
  qgmg->wkb_two_fluids.mode1_zeta_scale  = cbrt (cabs (delta1v_zeta1 * delta2v_zeta1));
  qgmg->wkb_two_fluids.mode1_Q_scale     = cbrt (cabs (delta1v_Q1 * delta2v_Q1));
  qgmg->wkb_two_fluids.mode1_Pzeta_scale = cbrt (cabs (delta1v_Pzeta1 * delta2v_Pzeta1));
  qgmg->wkb_two_fluids.mode1_PQ_scale    = cbrt (cabs (delta1v_PQ1 * delta2v_PQ1));

  /* Mode 2: Effective Hubble radius estimates */
  qgmg->wkb_two_fluids.mode2_zeta_scale  = cbrt (cabs (delta1v_zeta2 * delta2v_zeta2));
  qgmg->wkb_two_fluids.mode2_Q_scale     = cbrt (cabs (delta1v_Q2 * delta2v_Q2));
  qgmg->wkb_two_fluids.mode2_Pzeta_scale = cbrt (cabs (delta1v_Pzeta2 * delta2v_Pzeta2));
  qgmg->wkb_two_fluids.mode2_PQ_scale    = cbrt (cabs (delta1v_PQ2 * delta2v_PQ2));

  /* Mode 1 and 2: Truncation error estimates */
  qgmg->wkb_two_fluids.mode1_scale = (cabs (delta1v_zeta1 * delta2v_zeta1)
                                      + cabs (delta1v_Q1 * delta2v_Q1)
                                      + cabs (delta1v_Pzeta1 * delta2v_Pzeta1)
                                      + cabs (delta1v_PQ1 * delta2v_PQ1));
  qgmg->wkb_two_fluids.mode2_scale = (cabs (delta1v_zeta2 * delta2v_zeta2)
                                      + cabs (delta1v_Q2 * delta2v_Q2)
                                      + cabs (delta1v_Pzeta2 * delta2v_Pzeta2)
                                      + cabs (delta1v_PQ2 * delta2v_PQ2));

  return &qgmg->wkb_two_fluids;
}
...
_nc_hipert_itwo_fluids_tv (NcHIPertITwoFluids *itf, gdouble alpha, gdouble k)
{
  ...
  if ((qgmg->tv_two_fluids.skey  != ncm_model_state_get_pkey (NCM_MODEL (itf))) ||
      (qgmg->tv_two_fluids.alpha != alpha) ||
      (qgmg->tv_two_fluids.k     != k))
  {
    const gdouble epsilon   = GSL_SIGN (alpha);
    const gdouble absalpha  = fabs (alpha);
    const gdouble w2        = W;
    ...
    qgmg->tv_two_fluids.zeta[NC_HIPERT_ITWO_FLUIDS_VARS_Q_R1] = +cos_phi * sc1 / Az_sFnu;
    qgmg->tv_two_fluids.zeta[NC_HIPERT_ITWO_FLUIDS_VARS_Q_R2] = -sin_phi * sc2 / Az_sFnu;
    qgmg->tv_two_fluids.zeta[NC_HIPERT_ITWO_FLUIDS_VARS_P_R1] = 0.0;
    qgmg->tv_two_fluids.zeta[NC_HIPERT_ITWO_FLUIDS_VARS_P_R2] = 0.0;

    qgmg->tv_two_fluids.s[NC_HIPERT_ITWO_FLUIDS_VARS_Q_R1] = +sin_phi * sc1 / As_sFnu;
    qgmg->tv_two_fluids.s[NC_HIPERT_ITWO_FLUIDS_VARS_Q_R2] = +cos_phi * sc2 / As_sFnu;
    qgmg->tv_two_fluids.s[NC_HIPERT_ITWO_FLUIDS_VARS_P_R1] = 0.0;
    qgmg->tv_two_fluids.s[NC_HIPERT_ITWO_FLUIDS_VARS_P_R2] = 0.0;

    qgmg->tv_two_fluids.Pzeta[NC_HIPERT_ITWO_FLUIDS_VARS_Q_R1] = +(cos_phi * Az_sFnu / (Fnu * sc1)) * (epsilon * (1.0 + 3.0 * c12) / (2.0 * c1) + (cos2_phi / c1 + sin2_phi / c2) * d1lnE);
    qgmg->tv_two_fluids.Pzeta[NC_HIPERT_ITWO_FLUIDS_VARS_Q_R2] = -(sin_phi * Az_sFnu / (Fnu * sc2)) * (epsilon * (1.0 + 3.0 * c22) / (2.0 * c2) + (cos2_phi / c1 + sin2_phi / c2) * d1lnE);
    qgmg->tv_two_fluids.Pzeta[NC_HIPERT_ITWO_FLUIDS_VARS_P_R1] = +cos_phi * Az_sFnu / sc1;
    qgmg->tv_two_fluids.Pzeta[NC_HIPERT_ITWO_FLUIDS_VARS_P_R2] = -sin_phi * Az_sFnu / sc2;

    /* 1.0 - 3.0 * c12 == 0.0 */
    qgmg->tv_two_fluids.Ps[NC_HIPERT_ITWO_FLUIDS_VARS_Q_R1] = +(sin_phi * As_sFnu / (Fnu * sc1)) * (epsilon * 0.0 * (1.0 - 3.0 * c12) / (2.0 * c1) + cos2_phi * (1.0 / c1 - 1.0 / c2) * d1lnE);
    qgmg->tv_two_fluids.Ps[NC_HIPERT_ITWO_FLUIDS_VARS_Q_R2] = +(cos_phi * As_sFnu / (Fnu * sc2)) * (epsilon * 1.0 * (1.0 - 3.0 * c22) / (2.0 * c2) + sin2_phi * (1.0 / c2 - 1.0 / c1) * d1lnE);
    qgmg->tv_two_fluids.Ps[NC_HIPERT_ITWO_FLUIDS_VARS_P_R1] = +sin_phi * As_sFnu / sc1;
    qgmg->tv_two_fluids.Ps[NC_HIPERT_ITWO_FLUIDS_VARS_P_R2] = +cos_phi * As_sFnu / sc2;

    qgmg->tv_two_fluids.skey  = ncm_model_state_get_pkey (NCM_MODEL (cosmo));
    qgmg->tv_two_fluids.alpha = alpha;
    qgmg->tv_two_fluids.k     = k;
  }

  return &qgmg->tv_two_fluids;
}
...
static gdouble
_nc_hicosmo_qgmg_gw_eval_xi (NcHIPertIGW *igw, const gdouble alpha, const gdouble k)
{
...
static gdouble
_nc_hicosmo_qgmg_gw_eval_F1 (NcHIPertIGW *igw, const gdouble alpha, const gdouble k)
{
  NcHICosmo *cosmo        = NC_HICOSMO (igw);
  const gdouble w2        = W;
  const gdouble epsilon   = GSL_SIGN (alpha);
...
static gdouble
_nc_hicosmo_qgmg_gw_eval_nu (NcHIPertIGW *igw, const gdouble alpha, const gdouble k)
{
  NcHICosmo *cosmo        = NC_HICOSMO (igw);
  const gdouble w2        = W;
  const gdouble epsilon   = GSL_SIGN (alpha);
...
static gdouble
_nc_hicosmo_qgmg_gw_eval_m (NcHIPertIGW *igw, const gdouble alpha, const gdouble k)
{
  NcHICosmo *cosmo        = NC_HICOSMO (igw);
  const gdouble w2        = W;
  const gdouble epsilon   = GSL_SIGN (alpha);
...
static gdouble
_nc_hicosmo_qgmg_gw_eval_unit (NcHIPertIGW *igw)
{
  NcHICosmo *cosmo     = NC_HICOSMO (igw);
  const gdouble RH_lp  = nc_hicosmo_RH_planck (cosmo);
...
static gdouble
_nc_hicosmo_qgmg_gw_eval_x (NcHIPertIGW *igw, const gdouble alpha)
{
  NcHICosmo *cosmo = NC_HICOSMO (igw);
...
static gdouble
_nc_hicosmo_qgmg_adiab_eval_xi (NcHIPertIAdiab *iad, const gdouble alpha, const gdouble k)
{
...
static gdouble
_nc_hicosmo_qgmg_adiab_eval_F1 (NcHIPertIAdiab *iad, const gdouble alpha, const gdouble k)
{
  NcHICosmo *cosmo          = NC_HICOSMO (iad);
  const gdouble epsilon     = GSL_SIGN (alpha);
  const gdouble absalpha    = fabs (alpha);
...
static gdouble
_nc_hicosmo_qgmg_adiab_eval_nu (NcHIPertIAdiab *iad, const gdouble alpha, const gdouble k)
{
  NcHICosmo *cosmo        = NC_HICOSMO (iad);
  const gdouble epsilon   = GSL_SIGN (alpha);
  const gdouble absalpha  = fabs (alpha);
...
static gdouble
_nc_hicosmo_qgmg_adiab_eval_m (NcHIPertIAdiab *iad, const gdouble alpha, const gdouble k)
{
  NcHICosmo *cosmo        = NC_HICOSMO (iad);
  const gdouble epsilon   = GSL_SIGN (alpha);
  const gdouble absalpha  = fabs (alpha);
...
static gdouble
_nc_hicosmo_qgmg_adiab_eval_unit (NcHIPertIAdiab *iad)
{
  NcHICosmo *cosmo     = NC_HICOSMO (iad);
  const gdouble RH_lp  = nc_hicosmo_RH_planck (cosmo);
  const gdouble factor = sqrt (8.0 * ncm_c_pi () / 3.0);
...
static gdouble
_nc_hicosmo_qgmg_adiab_eval_x (NcHIPertIAdiab *iad, const gdouble alpha)
{
  NcHICosmo *cosmo = NC_HICOSMO (iad);
  const gdouble xb = X_B;
...
static gdouble
_nc_hicosmo_qgmg_adiab_eval_p2Psi (NcHIPertIAdiab *iad, const gdouble alpha, const gdouble k)
{
  NcHICosmo *cosmo        = NC_HICOSMO (iad);
  const gdouble epsilon   = GSL_SIGN (alpha);
  const gdouble absalpha  = fabs (alpha);
...
static gdouble
_nc_hicosmo_qgmg_adiab_eval_p2drho (NcHIPertIAdiab *iad, const gdouble alpha, const gdouble k)
{
  NcHICosmo *cosmo        = NC_HICOSMO (iad);
  const gdouble epsilon   = GSL_SIGN (alpha);
  const gdouble absalpha  = fabs (alpha);
...
static gdouble
_nc_hicosmo_qgmg_adiab_eval_lapse (NcHIPertIAdiab *iad, const gdouble alpha)
{
  NcHICosmo *cosmo        = NC_HICOSMO (iad);
  const gdouble epsilon   = GSL_SIGN (alpha);
  const gdouble absalpha  = fabs (alpha);
 ...
 */
NcHICosmoQGMG *
nc_hicosmo_qgmg_new (void)
{
  NcHICosmoQGMG *qgmg = g_object_new (NC_TYPE_HICOSMO_QGMG, NULL);

...
static gdouble _nc_hicosmo_de_xcdm_E2Omega_de (NcHICosmoDE *cosmo_de, gdouble z);
static gdouble _nc_hicosmo_de_xcdm_dE2Omega_de_dz (NcHICosmoDE *cosmo_de, gdouble z);
static gdouble _nc_hicosmo_de_xcdm_d2E2Omega_de_dz2 (NcHICosmoDE *cosmo_de, gdouble z);
static gdouble _nc_hicosmo_de_xcdm_w_de (NcHICosmoDE *cosmo_de, gdouble z);
static gdouble _nc_hicosmo_de_xcdm_dw_de (NcHICosmoDE *cosmo_de, gdouble z);
static gdouble _nc_hicosmo_de_xcdm_ln_rho_rho0 (NcHICosmoDE *cosmo_de, gdouble z);
...
nc_hicosmo_de_xcdm_class_init (NcHICosmoDEXcdmClass *klass)
{
  ...
  nc_hicosmo_de_set_dw_de_impl (parent_class, &_nc_hicosmo_de_xcdm_dw_de);
...
static gdouble
_nc_hicosmo_de_xcdm_w_de (NcHICosmoDE *cosmo_de, gdouble z)
{
  return W;
}

static gdouble
_nc_hicosmo_de_xcdm_dw_de (NcHICosmoDE *cosmo_de, gdouble z)
{
  return 0.0;
}

static gdouble
_nc_hicosmo_de_xcdm_ln_rho_rho0 (NcHICosmoDE *cosmo_de, gdouble z)
{
  return 3.0 * (1.0 + W) * log1p (z);
}

...
int lensing_init(
  ...
  double ** d00  = NULL;  /* dmn[index_mu][index_l] */
  double ** d11  = NULL;
  double ** d2m2 = NULL;
  double ** d22  = NULL;
  double ** d20  = NULL;
  ...
  int l;
  double ll;
  double * cl_unlensed = NULL;  /* cl_unlensed[index_ct] */
  double * cl_tt = NULL; /* unlensed  cl, to be filled to avoid repeated calls to spectra_cl_at_l */
  ...
  double * cl_pp = NULL; /* potential cl, to be filled to avoid repeated calls to spectra_cl_at_l */

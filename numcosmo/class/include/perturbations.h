...
struct perturb_parameters_and_workspace
{
  ...
  const struct background *pba;  /**< pointer to the background structure */
...
int perturb_prepare_output_file (const struct background  *pba,
                                 struct perturbs          *ppt,
                                 struct perturb_workspace *ppw,
                                 int                      index_ikout,
                                 int                      index_md);

int perturb_prepare_output (const struct background *pba,
                            struct perturbs         *ppt);

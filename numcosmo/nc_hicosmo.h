...
NCM_INLINE gdouble nc_hicosmo_curvature_K (NcHICosmo *cosmo, gint *sgnK);
...
NCM_INLINE gdouble
nc_hicosmo_curvature_K (NcHICosmo *cosmo, gint *sgnK)
{
  const gdouble RH_Mpc = nc_hicosmo_RH_Mpc (cosmo);
  gdouble Omega_k0     = (1.0 - nc_hicosmo_Omega_t0 (cosmo));
  gdouble K;

  Omega_k0 = fabs (Omega_k0) < NC_HICOSMO_OMEGA_K0_LIMIT ? 0.0 : Omega_k0;

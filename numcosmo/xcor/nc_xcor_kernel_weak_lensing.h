 ...
 * @NC_XCOR_KERNEL_WEAK_LENSING_SPARAM_LEN: FIXME
 *
 */
 ...
 * @NC_XCOR_KERNEL_WEAK_LENSING_VPARAM_LEN: FIXME
 *
 */
...
NcXcorKernelWeakLensing *nc_xcor_kernel_weak_lensing_new (gdouble zmin, gdouble zmax, NcmSpline *dn_dz, gdouble nbar, gdouble intr_shear, NcDistance *dist);

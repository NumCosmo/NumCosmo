...
static gdouble
_nc_reduced_shear_calib_eval (NcReducedShearCalib *rs_calib, const gdouble g_th, const gdouble psf_size, const gdouble gal_size)
{
  g_error ("_nc_reduced_shear_calib_eval: not implemented");

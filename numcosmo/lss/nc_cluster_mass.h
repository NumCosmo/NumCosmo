...
struct _NcClusterMassClass
{
  ...
  gdouble (*intP_bin) (NcClusterMass *clusterm, NcHICosmo *cosmo, const gdouble lnM, const gdouble z, const gdouble *lnM_obs_lower, const gdouble *lnM_obs_upper, const gdouble *lnM_obs_params);
...
gboolean nc_cluster_mass_resample_vec (NcClusterMass *clusterm, NcHICosmo *cosmo, const gdouble lnM, gdouble z, NcmVector *lnM_obs, const NcmVector *lnM_obs_params, NcmRNG *rng);

...
#define NC_CLUSTER_MASS_ASCASO_DEFAULT_MU_P0  (0.0)
#define NC_CLUSTER_MASS_ASCASO_DEFAULT_MU_P1  (1.0)
#define NC_CLUSTER_MASS_ASCASO_DEFAULT_MU_P2  (1.0)
#define NC_CLUSTER_MASS_ASCASO_DEFAULT_SIGMA_P0  (0.04)
#define NC_CLUSTER_MASS_ASCASO_DEFAULT_SIGMA_P1  (0.0)

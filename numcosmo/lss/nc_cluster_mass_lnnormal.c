...
#define VECTOR (NCM_MODEL (mlnn))
#define BIAS   (ncm_model_orig_param_get (VECTOR, NC_CLUSTER_MASS_LNNORMAL_BIAS))
#define SIGMA  (ncm_model_orig_param_get (VECTOR, NC_CLUSTER_MASS_LNNORMAL_SIGMA))

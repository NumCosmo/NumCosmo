...
static gdouble
_nc_cluster_photoz_gauss_global_intp_bin (NcClusterRedshift *clusterz, NcHICosmo *cosmo, gdouble lnM, gdouble z, const gdouble *z_obs_lower, const gdouble *z_obs_upper, const gdouble *z_obs_params)
{
  NcmModel *model = NCM_MODEL (clusterz);
/*NcClusterPhotozGaussGlobal *pzg_global = NC_CLUSTER_PHOTOZ_GAUSS_GLOBAL (clusterz);*/
  const gdouble z_eff       = z + Z_BIAS;

...
int
calc_xi_dk14 (double *r, int Nr, double Mass, double conc, int delta, double om, double *xi_nfw)
{
  int i;
...
int
calc_rho_dk14 (double *r, int Nr, double Mass, double conc, int delta, double Omega_m, double *rho_nfw)
{
  int i;

...
static gdouble _nc_multiplicity_func_warren_eval (NcMultiplicityFunc *mulf, NcHICosmo *cosmo, gdouble sigma, gdouble lnR, gdouble z);
...
static gdouble
_nc_multiplicity_func_warren_eval (NcMultiplicityFunc *mulf, NcHICosmo *cosmo, gdouble sigma, gdouble lnR, gdouble z) /* $f(\sigma)$ Warren: astro-ph/0506395 */
{
  /* NcMultiplicityFuncWarren *mw = NC_MULTIPLICITY_FUNC_WARREN (mulf);
   *  NcMultiplicityFuncWarrenPrivate * const self = nc_multiplicity_func_warren_get_instance_private (mw); */

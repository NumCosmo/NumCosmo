...
typedef struct _NcMultiplicityFuncPSPrivate
{
  NcMultiplicityFuncMassDef mdef;
  gdouble delta_c;
  gdouble Delta;
} NcMultiplicityFuncPSPrivate;
...
static gdouble _nc_multiplicity_func_ps_eval (NcMultiplicityFunc *mulf, NcHICosmo *cosmo, gdouble sigma, gdouble lnR, gdouble z);
...
static gdouble
_nc_multiplicity_func_ps_eval (NcMultiplicityFunc *mulf, NcHICosmo *cosmo, gdouble sigma, gdouble lnR, gdouble z) /* f(\sigma) - Press \& Schechter (PS) */
{
  NcMultiplicityFuncPS *mps                = NC_MULTIPLICITY_FUNC_PS (mulf);
  NcMultiplicityFuncPSPrivate * const self = nc_multiplicity_func_ps_get_instance_private (mps);

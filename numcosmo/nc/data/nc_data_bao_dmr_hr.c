 ...
 *
 * See: [Ross et al. (2016)](https://arxiv.org/abs/1607.03145) and [Alam et al. (2016)](https://arxiv.org/abs/1607.03155).
 *
 ...
 * represents the mean values of the transverse distance $D_M$ and the Hubble parameter
 * $H$ at the redshift $z$ divided by the sound horizon at the last scattering surface
 * $r_s$.
 *
 */
...
typedef struct _NcDataBaoDMrHrPrivate
{
  gint placeholder;
} NcDataBaoDMrHrPrivate;
...
nc_data_bao_dmr_hr_new_from_id (NcDistance *dist, NcDataBaoId id)
{
  ...
  switch (id)
  {
    case NC_DATA_BAO_DMR_HR_SDSS_DR12_2016:
      ...
      break;
    default:                                                                 /* LCOV_EXCL_LINE */
      g_error ("nc_data_bao_dmr_hr_new_from_id: id %d not recognized.", id); /* LCOV_EXCL_LINE */
      break;                                                                 /* LCOV_EXCL_LINE */
  }

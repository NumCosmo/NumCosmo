 ...
 *
 * This object provides the computation of the gravitational perturbations. It solves the
 * equation of motion for the (cosmological) gauge invariant variables.
 *
 */
...
#include "nc/perturbations/nc_hipert_grav.h"
...
static GArray *
_nc_hipert_grav_get_deps (NcHIPertGrav *grav, guint vindex)
{
  g_error ("_nc_hipert_grav_get_deps: not implemented by `%s'.", G_OBJECT_TYPE_NAME (grav));
...
_nc_hipert_grav_get_G_scalar_info (NcHIPertGrav *grav)
{
  g_error ("_nc_hipert_grav_get_G_scalar_info: not implemented by `%s'.", G_OBJECT_TYPE_NAME (grav));

  return NULL;
}

static void
_nc_hipert_grav_get_G_scalar (NcHIPertGrav *grav, NcHIPertBGVar *bg_var, NcHIPertBGVarYDY *ydy, NcHIPertGravTScalar *T_scalar, NcHIPertGravScalar *G_scalar)
{
  g_error ("_nc_hipert_grav_get_G_scalar: not implemented by `%s'.", G_OBJECT_TYPE_NAME (grav));
}

static void
_nc_hipert_grav_get_dy_scalar (NcHIPertGrav *grav, NcHIPertBGVar *bg_var, NcHIPertBGVarYDY *ydy, NcHIPertGravTScalar *T_scalar, NcHIPertGravScalar *G_scalar)
{

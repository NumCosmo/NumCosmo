 ...
 *
 * This object implements the full Eisenstein-Hu (1998) fitting function for the
 * matter transfer function, including baryon acoustic features. The transfer
 * function is split into baryon and cold-dark-matter contributions,
 * \begin{equation*}
 *  T(k) = \frac{\Omega_b}{\Omega_m} T_b(k) + \frac{\Omega_{c}}{\Omega_m} T_c(k),
 * \end{equation*}
 * weighted by the baryon (#nc_hicosmo_Omega_b0), matter (#nc_hicosmo_Omega_m0),
 * and cold-dark-matter (#nc_hicosmo_Omega_c0) density parameters today.
 *

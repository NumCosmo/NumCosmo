...
NcDataClusterWL *nc_data_cluster_wl_new (NcGalaxySDShape *s_dist, NcGalaxySDZProxy *zp_dist, NcGalaxySDPosition *pos_dist, const gdouble z_cluster, const gdouble ra_cluster, const gdouble dec_cluster);
...
void nc_data_cluster_wl_gen_data (NcDataClusterWL *dcwl, NcHICosmo *cosmo, NcHaloDensityProfile *dp, NcWLSurfaceMassDensity *smd, guint nobs, NcmRNG *rng);
NcGalaxyWLObs *nc_data_cluster_wl_peek_obs (NcDataClusterWL *dcwl);
NcmMatrix *nc_data_cluster_wl_peek_data (NcDataClusterWL *dcwl);

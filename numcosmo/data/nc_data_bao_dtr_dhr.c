 ...
 * represents the mean values of the transverse distance $D_t$ and the Hubble distance
 * $D_H$ at the redshift $z$ divided by the sound horizon at the last scattering surface
 * $r_s$.
 *
 *
 */

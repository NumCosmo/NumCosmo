 ...
 * @NC_DATA_CMB_SHIFT_PARAMETER_WMAP7: FIXME
 * @NC_DATA_CMB_DISTANCE_PRIORS_WMAP7: FIXME
 *
 * FIXME
 */
typedef enum _NcDataCMBId
{
  ...
  NC_DATA_CMB_SHIFT_PARAMETER_WMAP7,
  NC_DATA_CMB_DISTANCE_PRIORS_WMAP7, /*< private >*/

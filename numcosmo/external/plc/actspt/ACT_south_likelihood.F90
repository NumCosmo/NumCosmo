...
contains
 ...
 ! ===================================================================================================================================
  SUBROUTINE act_south_likelihood_compute(cltt,amp_tsz,amp_ksz,xi,aps148,aps217,acib150,acib220,ncib,rps,rcib,ags,cas1,cas2,like_acts)
 ! ===================================================================================================================================

    IMPLICIT NONE
    REAL(8), intent(in) :: cltt(2:*), amp_tsz,amp_ksz,xi,aps148,aps217,acib150,acib220,ncib,rps,rcib,ags,cas1,cas2
       ...
       do il=2,tt_lmax
          if(j==1) then !148 GHz
             cltt_temp(il) = cltt(il) &
                             ...
                             +ags*cl_cir(il)*(f1_dust**2.d0/fp2**2.d0)**beta_g*fluxtempd1**2.d0 &
             ...
             cltt_temp(il) = cltt(il) &
                             ...
                             +ags*cl_cir(il)*(f2_dust*f1_dust/fp2/fp3)**beta_g*fluxtempd2*fluxtempd1 &
                             +amp_ksz*cl_ksz(il) &
             ...
             cltt_temp(il) = cltt(il) &
                             ...
                             +ags*cl_cir(il)*(f2_dust**2.d0/fp3**2.d0)**beta_g*fluxtempd2**2.d0 &
                             +amp_ksz*cl_ksz(il)
          endif
    ...
    do i =0,nbin12-1
       do j=0,nsp12_s-1
          diffs(i+1+nsp11_s*nbin11+j*nbin12,1) = btt_dat12(j+1,i) - btt_th(2,i+13)
       enddo
    enddo
    do i=0,nbin22-1
       do j=0,nsp22_s-1
          diffs(i+1+nsp11_s*nbin11+nsp12_s*nbin12+j*nbin22,1) = btt_dat2(j+1,i) - btt_th(3,i+13)
       enddo 
   enddo

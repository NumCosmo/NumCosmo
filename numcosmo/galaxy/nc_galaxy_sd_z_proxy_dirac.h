...
NcGalaxySDZProxyDirac *nc_galaxy_sd_z_proxy_dirac_ref (NcGalaxySDZProxyDirac *gsdzpgauss);

void nc_galaxy_sd_z_proxy_dirac_free (NcGalaxySDZProxyDirac *gsdzpgauss);
void nc_galaxy_sd_z_proxy_dirac_clear (NcGalaxySDZProxyDirac **gsdzpgauss);

...
static gdouble _nc_galaxy_sd_z_proxy_dirac_gen (NcGalaxySDZProxy *gsdp, NcmRNG *rng, const gdouble z);
...
static gdouble
_nc_galaxy_sd_z_proxy_dirac_gen (NcGalaxySDZProxy *gsdp, NcmRNG *rng, const gdouble z)
{
  return z;
}

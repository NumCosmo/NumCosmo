...
struct _NcGalaxySDPositionClass
{
  ...
  gdouble (*gen_theta) (NcGalaxySDPosition *gsdp, NcmRNG *rng);
  gdouble (*gen_z) (NcGalaxySDPosition *gsdp, NcmRNG *rng);
  gdouble (*integ) (NcGalaxySDPosition *gsdp, const gdouble theta, const gdouble z);
  void (*set_z_lim) (NcGalaxySDPosition *gsdp, const gdouble z_min, const gdouble z_max);
  void (*set_theta_lim) (NcGalaxySDPosition *gsdp, const gdouble theta_min, const gdouble theta_max);
  void (*get_z_lim) (NcGalaxySDPosition *gsdp, gdouble *z_min, gdouble *z_max);
  void (*get_theta_lim) (NcGalaxySDPosition *gsdp, gdouble *theta_min, gdouble *theta_max);
...
void nc_galaxy_sd_position_set_theta_lim (NcGalaxySDPosition *gsdp, const gdouble theta_min, const gdouble theta_max);
void nc_galaxy_sd_position_get_theta_lim (NcGalaxySDPosition *gsdp, gdouble *theta_min, gdouble *theta_max);

gdouble nc_galaxy_sd_position_gen_theta (NcGalaxySDPosition *gsdp, NcmRNG *rng);
gdouble nc_galaxy_sd_position_gen_z (NcGalaxySDPosition *gsdp, NcmRNG *rng);
gdouble nc_galaxy_sd_position_integ (NcGalaxySDPosition *gsdp, const gdouble theta, const gdouble z);

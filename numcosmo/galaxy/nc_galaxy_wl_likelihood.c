...
nc_galaxy_wl_likelihood_eval_m2lnP (NcGalaxyWLLikelihood *gwl, NcHICosmo *cosmo, NcHaloDensityProfile *dp, NcWLSurfaceMassDensity *smd, const gdouble z_cluster, NcmMatrix *gal_obs, NcmVector *m2lnP_gal)
{
  ...
  g_assert_cmpuint (ncm_matrix_ncols (gal_obs), ==, 4);
  ...
  for (gal_i = 0; gal_i < len; gal_i++)
  {
    ...
    likelihood_integral->data.ex        = ncm_matrix_get (gal_obs, gal_i, 3);
...
nc_galaxy_wl_likelihood_kde_eval_m2lnP (NcGalaxyWLLikelihood *gwl, NcHICosmo *cosmo, NcHaloDensityProfile *dp, NcWLSurfaceMassDensity *smd, const gdouble z_cluster, NcmMatrix *gal_obs, NcmVector *m2lnP_gal)
{
  ...
  if (m2lnP_gal != NULL)
  {
    for (gal_i = 0; gal_i < len; gal_i++)
    {
      ...
      const gdouble et_i = ncm_matrix_get (gal_obs, gal_i, 2);
      const gdouble ex_i = ncm_matrix_get (gal_obs, gal_i, 3);
 ...
 */
void
nc_galaxy_wl_likelihood_set_cut (NcGalaxyWLLikelihood *gwl, const gdouble r_min, const gdouble r_max)
{
  NcGalaxyWLLikelihoodPrivate * const self = gwl->priv;
 ...
 * @rng: a #NcmRNG
 *
 * Returns: (transfer full): a #NcmVector with a randomly generated observation.
 *
 */
NcmVector *
nc_galaxy_wl_likelihood_gen (NcGalaxyWLLikelihood *gwl, NcHICosmo *cosmo, NcHaloDensityProfile *dp, NcWLSurfaceMassDensity *smd, const gdouble z_cluster, NcmRNG *rng)
{
  NcGalaxyWLLikelihoodPrivate * const self = gwl->priv;

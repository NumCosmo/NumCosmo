...
struct _NcHIPertTwoFluids
{
  ...
  NcmOdeSpline *wkb_zeta_phase;
  NcmOdeSpline *wkb_S_phase;
  gboolean zeta_wkb_prepared;
  gboolean S_wkb_prepared;
};
...
#define NC_HIPERT_TWO_FLUIDS_ALPHA2TAU(alpha) (GSL_SIGN(alpha) * (alpha) * (alpha) * 0.5)
#define NC_HIPERT_TWO_FLUIDS_TAU2ALPHA(tau) (GSL_SIGN(tau) * sqrt (2.0 * fabs (tau)))
#define NC_HIPERT_TWO_FLUIDS_DALPHADTAU(alpha) (1.0 / fabs (alpha))

/*
#define NC_HIPERT_TWO_FLUIDS_ALPHA2TAU(alpha) (alpha)
#define NC_HIPERT_TWO_FLUIDS_TAU2ALPHA(tau) (tau)
#define NC_HIPERT_TWO_FLUIDS_DALPHADTAU(alpha) (1.0)
*/
G_END_DECLS

...
static gdouble
_ncm_hoaa_eval_mnu (NcmHOAA *hoaa, NcmModel *model, const gdouble t, const gdouble k)
{
  g_error ("_ncm_hoaa_eval_mnu: not implemented.");

  return 0.0;
}

static gdouble
_ncm_hoaa_eval_nu (NcmHOAA *hoaa, NcmModel *model, const gdouble t, const gdouble k)
{
  g_error ("_ncm_hoaa_eval_nu: not implemented.");

  return 0.0;
}

static gdouble
_ncm_hoaa_eval_dlnmnu (NcmHOAA *hoaa, NcmModel *model, const gdouble t, const gdouble k)
{
  g_error ("_ncm_hoaa_eval_dlnmnu: not implemented.");

  return 0.0;
}

static gdouble
_ncm_hoaa_eval_V (NcmHOAA *hoaa, NcmModel *model, const gdouble t, const gdouble k)
{
  g_error ("_ncm_hoaa_eval_V: not implemented.");

  return 0.0;
}

static void
_ncm_hoaa_eval_system (NcmHOAA *hoaa, NcmModel *model, const gdouble t, const gdouble k, gdouble *nu, gdouble *dlnmnu, gdouble *Vnu)
{
  g_error ("_ncm_hoaa_eval_system: not implemented.");
}

static guint
_ncm_hoaa_nsing (NcmHOAA *hoaa, NcmModel *model, const gdouble k)
{
  g_error ("_ncm_hoaa_nsing: not implemented.");

  return 0;
}

static void
_ncm_hoaa_get_sing_info (NcmHOAA *hoaa, NcmModel *model, const gdouble k, const guint sing, gdouble *ts, gdouble *dts_i, gdouble *dts_f, NcmHOAASingType *st)
{
  g_error ("_ncm_hoaa_get_sing_info: not implemented.");
}

static gdouble
_ncm_hoaa_eval_sing_mnu (NcmHOAA *hoaa, NcmModel *model, const gdouble t_m_ts, const gdouble k, const guint sing)
{
  g_error ("_ncm_hoaa_eval_sing_mnu: not implemented.");

  return 0.0;
}

static gdouble
_ncm_hoaa_eval_sing_dlnmnu (NcmHOAA *hoaa, NcmModel *model, const gdouble t_m_ts, const gdouble k, const guint sing)
{
  g_error ("_ncm_hoaa_eval_sing_dlnmnu: not implemented.");

  return 0.0;
}

static gdouble
_ncm_hoaa_eval_sing_V (NcmHOAA *hoaa, NcmModel *model, const gdouble t_m_ts, const gdouble k, const guint sing)
{
  g_error ("_ncm_hoaa_eval_sing_V: not implemented.");

  return 0.0;
}

static void
_ncm_hoaa_eval_sing_system (NcmHOAA *hoaa, NcmModel *model, const gdouble t_m_ts, const gdouble k, const guint sing, gdouble *nu, gdouble *dlnmnu, gdouble *Vnu)
{
  {
    g_error ("_ncm_hoaa_eval_sing_system: not implemented.");
  }
}

static void
_ncm_hoaa_prepare (NcmHOAA *hoaa, NcmModel *model)
{
  g_error ("_ncm_hoaa_prepare: not implemented.");
}

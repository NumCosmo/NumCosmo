...
NcmSBesselIntegratorLevin *ncm_sbessel_integrator_levin_new (guint ell_min, guint ell_max, gdouble y_knots_min, gdouble y_knots_max, guint n_knots, guint ell_cache_max);
